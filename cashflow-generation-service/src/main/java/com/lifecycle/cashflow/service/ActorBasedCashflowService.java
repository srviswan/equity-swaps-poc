...
import com.lifecycle.cashflow.actor.ActorSystem;
import com.lifecycle.cashflow.actor.CashflowGenerationActor;
...
public class ActorBasedCashflowService {
    ...
    public void cleanup() {
        ...
        try {
            ...
            actorSystem.shutdown()
                ...
                .subscribe(
                    result -> logger.info("Actor system shutdown completed successfully"),
                    error -> logger.warn("Actor system shutdown completed with warnings: {}", error.getMessage())
                );
        } catch (Exception e) {
    ...
    public Mono<CashflowGenerationActorState> getActorStatistics(String actorName) {
        ...
        return actor.getState().timeout(Duration.ofSeconds(10));
    }
    ...
    public Mono<Void> stopActor(String actorName) {
        ...
        return actorSystem.stopActor(actorName).timeout(Duration.ofSeconds(10));
    }
