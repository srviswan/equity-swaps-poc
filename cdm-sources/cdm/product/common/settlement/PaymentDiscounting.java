 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PaymentDiscounting", builder=PaymentDiscounting.PaymentDiscountingBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PaymentDiscounting", model="Just another Rosetta model", builder=PaymentDiscounting.PaymentDiscountingBuilderImpl.class, version="6.0.0")
