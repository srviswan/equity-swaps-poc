 ...
 * @version 6.0.0
 */
@RosettaDataType(value="SettlementProvision", builder=SettlementProvision.SettlementProvisionBuilderImpl.class, version="6.0.0")
@RuneDataType(value="SettlementProvision", model="Just another Rosetta model", builder=SettlementProvision.SettlementProvisionBuilderImpl.class, version="6.0.0")
