 ...
 * @version 6.0.0
 */
@RosettaDataType(value="QuantityMultiplier", builder=QuantityMultiplier.QuantityMultiplierBuilderImpl.class, version="6.0.0")
@RuneDataType(value="QuantityMultiplier", model="Just another Rosetta model", builder=QuantityMultiplier.QuantityMultiplierBuilderImpl.class, version="6.0.0")
