 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ComputedAmount", builder=ComputedAmount.ComputedAmountBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ComputedAmount", model="Just another Rosetta model", builder=ComputedAmount.ComputedAmountBuilderImpl.class, version="6.0.0")
