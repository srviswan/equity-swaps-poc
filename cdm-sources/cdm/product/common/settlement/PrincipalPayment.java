 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PrincipalPayment", builder=PrincipalPayment.PrincipalPaymentBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PrincipalPayment", model="Just another Rosetta model", builder=PrincipalPayment.PrincipalPaymentBuilderImpl.class, version="6.0.0")
