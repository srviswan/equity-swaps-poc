 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PaymentRule", builder=PaymentRule.PaymentRuleBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PaymentRule", model="Just another Rosetta model", builder=PaymentRule.PaymentRuleBuilderImpl.class, version="6.0.0")
