 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FxFixingDate", builder=FxFixingDate.FxFixingDateBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FxFixingDate", model="Just another Rosetta model", builder=FxFixingDate.FxFixingDateBuilderImpl.class, version="6.0.0")
