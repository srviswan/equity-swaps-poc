 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PhysicalSettlementPeriod", builder=PhysicalSettlementPeriod.PhysicalSettlementPeriodBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PhysicalSettlementPeriod", model="Just another Rosetta model", builder=PhysicalSettlementPeriod.PhysicalSettlementPeriodBuilderImpl.class, version="6.0.0")
