 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PrincipalPaymentSchedule", builder=PrincipalPaymentSchedule.PrincipalPaymentScheduleBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PrincipalPaymentSchedule", model="Just another Rosetta model", builder=PrincipalPaymentSchedule.PrincipalPaymentScheduleBuilderImpl.class, version="6.0.0")
