 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PhysicalSettlementTerms", builder=PhysicalSettlementTerms.PhysicalSettlementTermsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PhysicalSettlementTerms", model="Just another Rosetta model", builder=PhysicalSettlementTerms.PhysicalSettlementTermsBuilderImpl.class, version="6.0.0")
