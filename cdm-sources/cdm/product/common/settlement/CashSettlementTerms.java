 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CashSettlementTerms", builder=CashSettlementTerms.CashSettlementTermsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CashSettlementTerms", model="Just another Rosetta model", builder=CashSettlementTerms.CashSettlementTermsBuilderImpl.class, version="6.0.0")
