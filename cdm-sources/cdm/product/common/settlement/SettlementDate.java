 ...
 * @version 6.0.0
 */
@RosettaDataType(value="SettlementDate", builder=SettlementDate.SettlementDateBuilderImpl.class, version="6.0.0")
@RuneDataType(value="SettlementDate", model="Just another Rosetta model", builder=SettlementDate.SettlementDateBuilderImpl.class, version="6.0.0")
