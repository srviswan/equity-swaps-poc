 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PercentageRule", builder=PercentageRule.PercentageRuleBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PercentageRule", model="Just another Rosetta model", builder=PercentageRule.PercentageRuleBuilderImpl.class, version="6.0.0")
