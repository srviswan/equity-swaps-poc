 ...
 * @version 6.0.0
 */
@RosettaDataType(value="RollFeature", builder=RollFeature.RollFeatureBuilderImpl.class, version="6.0.0")
@RuneDataType(value="RollFeature", model="Just another Rosetta model", builder=RollFeature.RollFeatureBuilderImpl.class, version="6.0.0")
