 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CommodityPriceReturnTerms", builder=CommodityPriceReturnTerms.CommodityPriceReturnTermsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CommodityPriceReturnTerms", model="Just another Rosetta model", builder=CommodityPriceReturnTerms.CommodityPriceReturnTermsBuilderImpl.class, version="6.0.0")
