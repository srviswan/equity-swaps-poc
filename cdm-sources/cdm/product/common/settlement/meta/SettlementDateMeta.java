...
public class SettlementDateMeta implements RosettaMetaData<SettlementDate> {
	...
	public List<Validator<? super SettlementDate>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.common.settlement.SettlementDate>create(cdm.product.common.settlement.validation.datarule.SettlementDateBusinessDays.class),
			factory.<cdm.product.common.settlement.SettlementDate>create(cdm.product.common.settlement.validation.datarule.SettlementDateDateChoice.class)
		);
	}
