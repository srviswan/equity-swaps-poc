...
public class DeliverableObligationsMeta implements RosettaMetaData<DeliverableObligations> {
	...
	public List<Validator<? super DeliverableObligations>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.common.settlement.DeliverableObligations>create(cdm.product.common.settlement.validation.datarule.DeliverableObligationsDeliverableObligationsChoice.class),
			factory.<cdm.product.common.settlement.DeliverableObligations>create(cdm.product.common.settlement.validation.datarule.DeliverableObligationsFpMLCd34.class)
		);
	}
