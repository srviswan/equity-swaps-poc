...
public class PhysicalSettlementTermsMeta implements RosettaMetaData<PhysicalSettlementTerms> {
	...
	public List<Validator<? super PhysicalSettlementTerms>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.common.settlement.PhysicalSettlementTerms>create(cdm.product.common.settlement.validation.datarule.PhysicalSettlementTermsPredeterminedClearingOrganizationParty.class)
		);
	}
