...
public class SettlementTermsMeta implements RosettaMetaData<SettlementTerms> {
	...
	public List<Validator<? super SettlementTerms>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.common.settlement.SettlementTerms>create(cdm.product.common.settlement.validation.datarule.SettlementTermsOptionSettlementChoice.class),
			factory.<cdm.product.common.settlement.SettlementTerms>create(cdm.product.common.settlement.validation.datarule.SettlementTermsCashSettlementTerms.class),
			factory.<cdm.product.common.settlement.SettlementTerms>create(cdm.product.common.settlement.validation.datarule.SettlementTermsPhysicalSettlementTerms.class)
		);
	}
