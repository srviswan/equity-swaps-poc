...
public class PhysicalSettlementPeriodMeta implements RosettaMetaData<PhysicalSettlementPeriod> {
	...
	public List<Validator<? super PhysicalSettlementPeriod>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.common.settlement.PhysicalSettlementPeriod>create(cdm.product.common.settlement.validation.datarule.PhysicalSettlementPeriodOneOf0.class),
			factory.<cdm.product.common.settlement.PhysicalSettlementPeriod>create(cdm.product.common.settlement.validation.datarule.PhysicalSettlementPeriodBusinessDays.class),
			factory.<cdm.product.common.settlement.PhysicalSettlementPeriod>create(cdm.product.common.settlement.validation.datarule.PhysicalSettlementPeriodMaximumBusinessDays.class)
		);
	}
