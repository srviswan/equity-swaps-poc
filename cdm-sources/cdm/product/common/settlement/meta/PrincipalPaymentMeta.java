...
public class PrincipalPaymentMeta implements RosettaMetaData<PrincipalPayment> {
	...
	public List<Validator<? super PrincipalPayment>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.common.settlement.PrincipalPayment>create(cdm.product.common.settlement.validation.datarule.PrincipalPaymentPrincipalAmount.class),
			factory.<cdm.product.common.settlement.PrincipalPayment>create(cdm.product.common.settlement.validation.datarule.PrincipalPaymentDiscountFactor.class)
		);
	}
