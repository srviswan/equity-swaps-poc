 ...
 * @version 6.0.0
 */
@RosettaDataType(value="SettlementBase", builder=SettlementBase.SettlementBaseBuilderImpl.class, version="6.0.0")
@RuneDataType(value="SettlementBase", model="Just another Rosetta model", builder=SettlementBase.SettlementBaseBuilderImpl.class, version="6.0.0")
