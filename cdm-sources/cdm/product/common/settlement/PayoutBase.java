 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PayoutBase", builder=PayoutBase.PayoutBaseBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PayoutBase", model="Just another Rosetta model", builder=PayoutBase.PayoutBaseBuilderImpl.class, version="6.0.0")
