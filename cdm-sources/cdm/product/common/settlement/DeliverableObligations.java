 ...
 * @version 6.0.0
 */
@RosettaDataType(value="DeliverableObligations", builder=DeliverableObligations.DeliverableObligationsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="DeliverableObligations", model="Just another Rosetta model", builder=DeliverableObligations.DeliverableObligationsBuilderImpl.class, version="6.0.0")
