 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FixedPrice", builder=FixedPrice.FixedPriceBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FixedPrice", model="Just another Rosetta model", builder=FixedPrice.FixedPriceBuilderImpl.class, version="6.0.0")
