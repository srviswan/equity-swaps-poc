 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CashflowType", builder=CashflowType.CashflowTypeBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CashflowType", model="Just another Rosetta model", builder=CashflowType.CashflowTypeBuilderImpl.class, version="6.0.0")
