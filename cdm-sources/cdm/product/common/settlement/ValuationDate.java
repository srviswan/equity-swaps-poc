 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ValuationDate", builder=ValuationDate.ValuationDateBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ValuationDate", model="Just another Rosetta model", builder=ValuationDate.ValuationDateBuilderImpl.class, version="6.0.0")
