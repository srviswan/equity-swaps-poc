 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PCDeliverableObligationCharac", builder=PCDeliverableObligationCharac.PCDeliverableObligationCharacBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PCDeliverableObligationCharac", model="Just another Rosetta model", builder=PCDeliverableObligationCharac.PCDeliverableObligationCharacBuilderImpl.class, version="6.0.0")
