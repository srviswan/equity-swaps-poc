 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FxLinkedNotionalAmount", builder=FxLinkedNotionalAmount.FxLinkedNotionalAmountBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FxLinkedNotionalAmount", model="Just another Rosetta model", builder=FxLinkedNotionalAmount.FxLinkedNotionalAmountBuilderImpl.class, version="6.0.0")
