 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Lag", builder=Lag.LagBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Lag", model="Just another Rosetta model", builder=Lag.LagBuilderImpl.class, version="6.0.0")
