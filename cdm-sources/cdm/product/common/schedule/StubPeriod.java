 ...
 * @version 6.0.0
 */
@RosettaDataType(value="StubPeriod", builder=StubPeriod.StubPeriodBuilderImpl.class, version="6.0.0")
@RuneDataType(value="StubPeriod", model="Just another Rosetta model", builder=StubPeriod.StubPeriodBuilderImpl.class, version="6.0.0")
