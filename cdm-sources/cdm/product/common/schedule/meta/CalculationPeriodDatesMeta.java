...
public class CalculationPeriodDatesMeta implements RosettaMetaData<CalculationPeriodDates> {
	...
	public List<Validator<? super CalculationPeriodDates>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.common.schedule.CalculationPeriodDates>create(cdm.product.common.schedule.validation.datarule.CalculationPeriodDatesFpMLIrd16.class),
			factory.<cdm.product.common.schedule.CalculationPeriodDates>create(cdm.product.common.schedule.validation.datarule.CalculationPeriodDatesFpMLIrd17.class),
			factory.<cdm.product.common.schedule.CalculationPeriodDates>create(cdm.product.common.schedule.validation.datarule.CalculationPeriodDatesFpMLIrd18.class),
			factory.<cdm.product.common.schedule.CalculationPeriodDates>create(cdm.product.common.schedule.validation.datarule.CalculationPeriodDatesFpMLIrd20.class),
			factory.<cdm.product.common.schedule.CalculationPeriodDates>create(cdm.product.common.schedule.validation.datarule.CalculationPeriodDatesFpMLIrd21.class),
			factory.<cdm.product.common.schedule.CalculationPeriodDates>create(cdm.product.common.schedule.validation.datarule.CalculationPeriodDatesFpMLIrd22.class)
		);
	}
