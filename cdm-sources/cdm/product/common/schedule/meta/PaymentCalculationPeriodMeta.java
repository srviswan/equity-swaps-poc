...
public class PaymentCalculationPeriodMeta implements RosettaMetaData<PaymentCalculationPeriod> {
	...
	public List<Validator<? super PaymentCalculationPeriod>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.common.schedule.PaymentCalculationPeriod>create(cdm.product.common.schedule.validation.datarule.PaymentCalculationPeriodCalculationPeriodNumberOfDays.class),
			factory.<cdm.product.common.schedule.PaymentCalculationPeriod>create(cdm.product.common.schedule.validation.datarule.PaymentCalculationPeriodPaymentCalculationPeriodChoice.class),
			factory.<cdm.product.common.schedule.PaymentCalculationPeriod>create(cdm.product.common.schedule.validation.datarule.PaymentCalculationPeriodFpMLIrd34.class)
		);
	}
