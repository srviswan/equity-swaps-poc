...
public class PaymentDatesMeta implements RosettaMetaData<PaymentDates> {
	...
	public List<Validator<? super PaymentDates>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.common.schedule.PaymentDates>create(cdm.product.common.schedule.validation.datarule.PaymentDatesFpMLIrd35Cd31.class),
			factory.<cdm.product.common.schedule.PaymentDates>create(cdm.product.common.schedule.validation.datarule.PaymentDatesNonZeroPeriodMultiplier.class)
		);
	}
