...
public class WeightedAveragingObservationMeta implements RosettaMetaData<WeightedAveragingObservation> {
	...
	public List<Validator<? super WeightedAveragingObservation>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.common.schedule.WeightedAveragingObservation>create(cdm.product.common.schedule.validation.datarule.WeightedAveragingObservationWeightedAveragingObservationChoice.class),
			factory.<cdm.product.common.schedule.WeightedAveragingObservation>create(cdm.product.common.schedule.validation.datarule.WeightedAveragingObservationPositiveObservationNumber.class),
			factory.<cdm.product.common.schedule.WeightedAveragingObservation>create(cdm.product.common.schedule.validation.datarule.WeightedAveragingObservationPositiveWeight.class)
		);
	}
