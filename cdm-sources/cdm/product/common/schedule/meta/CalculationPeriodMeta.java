...
public class CalculationPeriodMeta implements RosettaMetaData<CalculationPeriod> {
	...
	public List<Validator<? super CalculationPeriod>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.common.schedule.CalculationPeriod>create(cdm.product.common.schedule.validation.datarule.CalculationPeriodNotionalChoice.class),
			factory.<cdm.product.common.schedule.CalculationPeriod>create(cdm.product.common.schedule.validation.datarule.CalculationPeriodRateChoice.class),
			factory.<cdm.product.common.schedule.CalculationPeriod>create(cdm.product.common.schedule.validation.datarule.CalculationPeriodStartDateChoice.class),
			factory.<cdm.product.common.schedule.CalculationPeriod>create(cdm.product.common.schedule.validation.datarule.CalculationPeriodEndDateChoice.class)
		);
	}
