...
public class ResetDatesMeta implements RosettaMetaData<ResetDates> {
	...
	public List<Validator<? super ResetDates>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.common.schedule.ResetDates>create(cdm.product.common.schedule.validation.datarule.ResetDatesRateCutOffDaysOffset.class),
			factory.<cdm.product.common.schedule.ResetDates>create(cdm.product.common.schedule.validation.datarule.ResetDatesWeeklyPeriod.class),
			factory.<cdm.product.common.schedule.ResetDates>create(cdm.product.common.schedule.validation.datarule.ResetDatesNonWeeklyPeriod.class)
		);
	}
