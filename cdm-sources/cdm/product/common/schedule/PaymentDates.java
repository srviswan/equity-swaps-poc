 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PaymentDates", builder=PaymentDates.PaymentDatesBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PaymentDates", model="Just another Rosetta model", builder=PaymentDates.PaymentDatesBuilderImpl.class, version="6.0.0")
