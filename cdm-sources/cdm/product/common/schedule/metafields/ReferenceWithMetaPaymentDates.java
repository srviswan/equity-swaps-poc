...
@RuneDataType(value="ReferenceWithMetaPaymentDates", model="Just another Rosetta model", builder=ReferenceWithMetaPaymentDates.ReferenceWithMetaPaymentDatesBuilderImpl.class, version="0.0.0")
