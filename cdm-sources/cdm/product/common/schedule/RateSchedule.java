 ...
 * @version 6.0.0
 */
@RosettaDataType(value="RateSchedule", builder=RateSchedule.RateScheduleBuilderImpl.class, version="6.0.0")
@RuneDataType(value="RateSchedule", model="Just another Rosetta model", builder=RateSchedule.RateScheduleBuilderImpl.class, version="6.0.0")
