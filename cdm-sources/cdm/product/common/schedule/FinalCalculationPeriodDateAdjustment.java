 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FinalCalculationPeriodDateAdjustment", builder=FinalCalculationPeriodDateAdjustment.FinalCalculationPeriodDateAdjustmentBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FinalCalculationPeriodDateAdjustment", model="Just another Rosetta model", builder=FinalCalculationPeriodDateAdjustment.FinalCalculationPeriodDateAdjustmentBuilderImpl.class, version="6.0.0")
public interface FinalCalculationPeriodDateAdjustment extends RosettaModelObject {
	...
	class FinalCalculationPeriodDateAdjustmentBuilderImpl implements FinalCalculationPeriodDateAdjustment.FinalCalculationPeriodDateAdjustmentBuilder {
		...
		@RosettaAttribute("swapStreamReference")
		@RuneAttribute("swapStreamReference")
		public FinalCalculationPeriodDateAdjustment.FinalCalculationPeriodDateAdjustmentBuilder setSwapStreamReference(ReferenceWithMetaInterestRatePayout _swapStreamReference) {
			this.swapStreamReference = _swapStreamReference == null ? null : _swapStreamReference.toBuilder();
			return this;
		}
		
		@Override
		public FinalCalculationPeriodDateAdjustment.FinalCalculationPeriodDateAdjustmentBuilder setSwapStreamReferenceValue(InterestRatePayout _swapStreamReference) {
