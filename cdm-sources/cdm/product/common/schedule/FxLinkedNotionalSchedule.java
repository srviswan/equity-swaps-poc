 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FxLinkedNotionalSchedule", builder=FxLinkedNotionalSchedule.FxLinkedNotionalScheduleBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FxLinkedNotionalSchedule", model="Just another Rosetta model", builder=FxLinkedNotionalSchedule.FxLinkedNotionalScheduleBuilderImpl.class, version="6.0.0")
