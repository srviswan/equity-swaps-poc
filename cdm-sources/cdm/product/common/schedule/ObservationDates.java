 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ObservationDates", builder=ObservationDates.ObservationDatesBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ObservationDates", model="Just another Rosetta model", builder=ObservationDates.ObservationDatesBuilderImpl.class, version="6.0.0")
