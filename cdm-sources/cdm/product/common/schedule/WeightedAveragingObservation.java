 ...
 * @version 6.0.0
 */
@RosettaDataType(value="WeightedAveragingObservation", builder=WeightedAveragingObservation.WeightedAveragingObservationBuilderImpl.class, version="6.0.0")
@RuneDataType(value="WeightedAveragingObservation", model="Just another Rosetta model", builder=WeightedAveragingObservation.WeightedAveragingObservationBuilderImpl.class, version="6.0.0")
