...
@RuneDataType(value="ReferenceWithMetaCollateral", model="Just another Rosetta model", builder=ReferenceWithMetaCollateral.ReferenceWithMetaCollateralBuilderImpl.class, version="0.0.0")
