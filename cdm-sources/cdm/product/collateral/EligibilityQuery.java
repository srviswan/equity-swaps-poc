 ...
 * @version 6.0.0
 */
@RosettaDataType(value="EligibilityQuery", builder=EligibilityQuery.EligibilityQueryBuilderImpl.class, version="6.0.0")
@RuneDataType(value="EligibilityQuery", model="Just another Rosetta model", builder=EligibilityQuery.EligibilityQueryBuilderImpl.class, version="6.0.0")
