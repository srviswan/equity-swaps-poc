 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ReturnAmount", builder=ReturnAmount.ReturnAmountBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ReturnAmount", model="Just another Rosetta model", builder=ReturnAmount.ReturnAmountBuilderImpl.class, version="6.0.0")
