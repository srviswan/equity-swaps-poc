 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CollateralInterestParameters", builder=CollateralInterestParameters.CollateralInterestParametersBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CollateralInterestParameters", model="Just another Rosetta model", builder=CollateralInterestParameters.CollateralInterestParametersBuilderImpl.class, version="6.0.0")
