 ...
 * @version 6.0.0
 */
@RosettaDataType(value="InterestAmountApplication", builder=InterestAmountApplication.InterestAmountApplicationBuilderImpl.class, version="6.0.0")
@RuneDataType(value="InterestAmountApplication", model="Just another Rosetta model", builder=InterestAmountApplication.InterestAmountApplicationBuilderImpl.class, version="6.0.0")
