 ...
 * @version 6.0.0
 */
@RosettaDataType(value="AverageTradingVolume", builder=AverageTradingVolume.AverageTradingVolumeBuilderImpl.class, version="6.0.0")
@RuneDataType(value="AverageTradingVolume", model="Just another Rosetta model", builder=AverageTradingVolume.AverageTradingVolumeBuilderImpl.class, version="6.0.0")
