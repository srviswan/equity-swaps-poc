 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CollateralValuationTreatment", builder=CollateralValuationTreatment.CollateralValuationTreatmentBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CollateralValuationTreatment", model="Just another Rosetta model", builder=CollateralValuationTreatment.CollateralValuationTreatmentBuilderImpl.class, version="6.0.0")
