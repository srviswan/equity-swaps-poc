 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CollateralInterestNotification", builder=CollateralInterestNotification.CollateralInterestNotificationBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CollateralInterestNotification", model="Just another Rosetta model", builder=CollateralInterestNotification.CollateralInterestNotificationBuilderImpl.class, version="6.0.0")
