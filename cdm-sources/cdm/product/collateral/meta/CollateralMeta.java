...
public class CollateralMeta implements RosettaMetaData<Collateral> {
	...
	public List<Validator<? super Collateral>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.collateral.Collateral>create(cdm.product.collateral.validation.datarule.CollateralCollateralExists.class),
			factory.<cdm.product.collateral.Collateral>create(cdm.product.collateral.validation.datarule.CollateralCollateralProvisions.class),
			factory.<cdm.product.collateral.Collateral>create(cdm.product.collateral.validation.datarule.CollateralCollateralchoice.class)
		);
	}
