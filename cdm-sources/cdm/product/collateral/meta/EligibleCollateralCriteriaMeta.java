...
public class EligibleCollateralCriteriaMeta implements RosettaMetaData<EligibleCollateralCriteria> {
	...
	public List<Validator<? super EligibleCollateralCriteria>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.collateral.EligibleCollateralCriteria>create(cdm.product.collateral.validation.datarule.EligibleCollateralCriteriaConcentrationLimitTypeIssueOSAmountDebtOnly.class),
			factory.<cdm.product.collateral.EligibleCollateralCriteria>create(cdm.product.collateral.validation.datarule.EligibleCollateralCriteriaConcentrationLimitTypeMarketCapEquityOnly.class),
			factory.<cdm.product.collateral.EligibleCollateralCriteria>create(cdm.product.collateral.validation.datarule.EligibleCollateralCriteriaAverageTradingVolumeEquityOnly.class)
		);
	}
