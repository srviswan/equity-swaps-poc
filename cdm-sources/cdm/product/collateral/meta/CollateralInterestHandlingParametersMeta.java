...
public class CollateralInterestHandlingParametersMeta implements RosettaMetaData<CollateralInterestHandlingParameters> {
	...
	public List<Validator<? super CollateralInterestHandlingParameters>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.collateral.CollateralInterestHandlingParameters>create(cdm.product.collateral.validation.datarule.CollateralInterestHandlingParametersAlternative.class),
			factory.<cdm.product.collateral.CollateralInterestHandlingParameters>create(cdm.product.collateral.validation.datarule.CollateralInterestHandlingParametersAlternative2.class)
		);
	}
