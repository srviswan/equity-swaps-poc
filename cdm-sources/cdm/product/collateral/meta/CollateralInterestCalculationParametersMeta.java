...
public class CollateralInterestCalculationParametersMeta implements RosettaMetaData<CollateralInterestCalculationParameters> {
	...
	public List<Validator<? super CollateralInterestCalculationParameters>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.collateral.CollateralInterestCalculationParameters>create(cdm.product.collateral.validation.datarule.CollateralInterestCalculationParametersInterestRate.class),
			factory.<cdm.product.collateral.CollateralInterestCalculationParameters>create(cdm.product.collateral.validation.datarule.CollateralInterestCalculationParametersDCF.class),
			factory.<cdm.product.collateral.CollateralInterestCalculationParameters>create(cdm.product.collateral.validation.datarule.CollateralInterestCalculationParametersCompoundingBC1.class),
			factory.<cdm.product.collateral.CollateralInterestCalculationParameters>create(cdm.product.collateral.validation.datarule.CollateralInterestCalculationParametersCompoundingBC2.class)
		);
	}
