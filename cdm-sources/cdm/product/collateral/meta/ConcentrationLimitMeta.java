...
public class ConcentrationLimitMeta implements RosettaMetaData<ConcentrationLimit> {
	...
	public List<Validator<? super ConcentrationLimit>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.collateral.ConcentrationLimit>create(cdm.product.collateral.validation.datarule.ConcentrationLimitConcentrationLimitValueChoice.class),
			factory.<cdm.product.collateral.ConcentrationLimit>create(cdm.product.collateral.validation.datarule.ConcentrationLimitPercentageConcentrationLimit.class)
		);
	}
