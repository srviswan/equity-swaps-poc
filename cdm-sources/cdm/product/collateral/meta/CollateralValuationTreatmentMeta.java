...
public class CollateralValuationTreatmentMeta implements RosettaMetaData<CollateralValuationTreatment> {
	...
	public List<Validator<? super CollateralValuationTreatment>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.collateral.CollateralValuationTreatment>create(cdm.product.collateral.validation.datarule.CollateralValuationTreatmentHaircutPercentage.class),
			factory.<cdm.product.collateral.CollateralValuationTreatment>create(cdm.product.collateral.validation.datarule.CollateralValuationTreatmentMarginPercentage.class),
			factory.<cdm.product.collateral.CollateralValuationTreatment>create(cdm.product.collateral.validation.datarule.CollateralValuationTreatmentFxHaircutPercentage.class),
			factory.<cdm.product.collateral.CollateralValuationTreatment>create(cdm.product.collateral.validation.datarule.CollateralValuationTreatmentAdditionalHaircutPercentage.class),
			factory.<cdm.product.collateral.CollateralValuationTreatment>create(cdm.product.collateral.validation.datarule.CollateralValuationTreatmentHaircutPercentageOrMarginPercentage.class)
		);
	}
