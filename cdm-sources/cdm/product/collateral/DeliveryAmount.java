 ...
 * @version 6.0.0
 */
@RosettaDataType(value="DeliveryAmount", builder=DeliveryAmount.DeliveryAmountBuilderImpl.class, version="6.0.0")
@RuneDataType(value="DeliveryAmount", model="Just another Rosetta model", builder=DeliveryAmount.DeliveryAmountBuilderImpl.class, version="6.0.0")
