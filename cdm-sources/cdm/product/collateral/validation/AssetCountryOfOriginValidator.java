...
public class AssetCountryOfOriginValidator implements Validator<AssetCountryOfOrigin> {
	...
	public ValidationResult<AssetCountryOfOrigin> validate(RosettaPath path, AssetCountryOfOrigin o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("AssetCountryOfOrigin", ValidationType.CARDINALITY, "AssetCountryOfOrigin", path, "", error);
		}
		return success("AssetCountryOfOrigin", ValidationType.CARDINALITY, "AssetCountryOfOrigin", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AssetCountryOfOrigin", ValidationType.CARDINALITY, "AssetCountryOfOrigin", path, "", res.getError());
				}
				return success("AssetCountryOfOrigin", ValidationType.CARDINALITY, "AssetCountryOfOrigin", path, "");
			})
			.collect(toList());
