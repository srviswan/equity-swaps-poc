...
public class CommodityPayoutMeta implements RosettaMetaData<CommodityPayout> {
	...
	public List<Validator<? super CommodityPayout>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			...
			factory.<cdm.product.asset.CommodityPayout>create(cdm.product.asset.validation.datarule.CommodityPayoutQuantity.class),
			factory.<cdm.product.asset.CommodityPayout>create(cdm.product.asset.validation.datarule.CommodityPayoutCalculationPeriod.class),
			factory.<cdm.product.asset.CommodityPayout>create(cdm.product.asset.validation.datarule.CommodityPayoutCommodityUnderlier.class),
			factory.<cdm.product.asset.CommodityPayout>create(cdm.product.asset.validation.datarule.CommodityPayoutDeliveryCapacity.class),
			factory.<cdm.product.asset.CommodityPayout>create(cdm.product.asset.validation.datarule.CommodityPayoutPriceTimeIntervalQuantity.class)
		);
	}
