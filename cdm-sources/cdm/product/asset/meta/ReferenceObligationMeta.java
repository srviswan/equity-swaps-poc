...
public class ReferenceObligationMeta implements RosettaMetaData<ReferenceObligation> {
	...
	public List<Validator<? super ReferenceObligation>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.asset.ReferenceObligation>create(cdm.product.asset.validation.datarule.ReferenceObligationAssetChoice.class),
			factory.<cdm.product.asset.ReferenceObligation>create(cdm.product.asset.validation.datarule.ReferenceObligationMustBeDebtSecurity.class),
			factory.<cdm.product.asset.ReferenceObligation>create(cdm.product.asset.validation.datarule.ReferenceObligationLegalEntityChoice.class)
		);
	}
