...
public class DividendReturnTermsMeta implements RosettaMetaData<DividendReturnTerms> {
	...
	public List<Validator<? super DividendReturnTerms>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.asset.DividendReturnTerms>create(cdm.product.asset.validation.datarule.DividendReturnTermsDividendPeriod.class),
			factory.<cdm.product.asset.DividendReturnTerms>create(cdm.product.asset.validation.datarule.DividendReturnTermsExtraordinaryDividendsParty.class)
		);
	}
