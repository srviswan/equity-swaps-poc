...
public class TrancheMeta implements RosettaMetaData<Tranche> {
	...
	public List<Validator<? super Tranche>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.asset.Tranche>create(cdm.product.asset.validation.datarule.TrancheAttachmentPoint.class),
			factory.<cdm.product.asset.Tranche>create(cdm.product.asset.validation.datarule.TrancheExhaustionPoint.class),
			factory.<cdm.product.asset.Tranche>create(cdm.product.asset.validation.datarule.TrancheAttachmentPointLessThanExhaustionPoint.class)
		);
	}
