...
public class BasketReferenceInformationMeta implements RosettaMetaData<BasketReferenceInformation> {
	...
	public List<Validator<? super BasketReferenceInformation>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.asset.BasketReferenceInformation>create(cdm.product.asset.validation.datarule.BasketReferenceInformationBasketReferenceInformationChoice.class),
			factory.<cdm.product.asset.BasketReferenceInformation>create(cdm.product.asset.validation.datarule.BasketReferenceInformationNthToDefault.class),
			factory.<cdm.product.asset.BasketReferenceInformation>create(cdm.product.asset.validation.datarule.BasketReferenceInformationMthToDefault.class)
		);
	}
