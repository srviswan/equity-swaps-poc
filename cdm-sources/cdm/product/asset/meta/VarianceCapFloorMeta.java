...
public class VarianceCapFloorMeta implements RosettaMetaData<VarianceCapFloor> {
	...
	public List<Validator<? super VarianceCapFloor>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.asset.VarianceCapFloor>create(cdm.product.asset.validation.datarule.VarianceCapFloorPositiveUnadjustedVarianceCap.class),
			factory.<cdm.product.asset.VarianceCapFloor>create(cdm.product.asset.validation.datarule.VarianceCapFloorCapFloorApplicability.class)
		);
	}
