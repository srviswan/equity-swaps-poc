...
public class VolatilityCapFloorMeta implements RosettaMetaData<VolatilityCapFloor> {
	...
	public List<Validator<? super VolatilityCapFloor>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.asset.VolatilityCapFloor>create(cdm.product.asset.validation.datarule.VolatilityCapFloorCapFloorApplicability.class),
			factory.<cdm.product.asset.VolatilityCapFloor>create(cdm.product.asset.validation.datarule.VolatilityCapFloorPositiveCaps.class)
		);
	}
