...
public class CorrelationReturnTermsMeta implements RosettaMetaData<CorrelationReturnTerms> {
	...
	public List<Validator<? super CorrelationReturnTerms>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			...
			factory.<cdm.product.asset.CorrelationReturnTerms>create(cdm.product.asset.validation.datarule.CorrelationReturnTermsPositiveNumberOfDataSeries.class),
			factory.<cdm.product.asset.CorrelationReturnTerms>create(cdm.product.asset.validation.datarule.CorrelationReturnTermsCorrelationValue.class)
		);
	}
