...
public class ReferencePoolMeta implements RosettaMetaData<ReferencePool> {
	...
	public List<Validator<? super ReferencePool>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.asset.ReferencePool>create(cdm.product.asset.validation.datarule.ReferencePoolFpMLCd44OpenUnits.class),
			factory.<cdm.product.asset.ReferencePool>create(cdm.product.asset.validation.datarule.ReferencePoolFpMLCd44BasketPercentage.class)
		);
	}
