...
public class DividendPayoutRatioMeta implements RosettaMetaData<DividendPayoutRatio> {
	...
	public List<Validator<? super DividendPayoutRatio>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.asset.DividendPayoutRatio>create(cdm.product.asset.validation.datarule.DividendPayoutRatioDividendPayoutRatioTotal.class),
			factory.<cdm.product.asset.DividendPayoutRatio>create(cdm.product.asset.validation.datarule.DividendPayoutRatioDividendPayoutRatioCash.class),
			factory.<cdm.product.asset.DividendPayoutRatio>create(cdm.product.asset.validation.datarule.DividendPayoutRatioDividendPayoutRatioNonCash.class)
		);
	}
