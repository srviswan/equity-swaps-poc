...
public class CreditDefaultPayoutMeta implements RosettaMetaData<CreditDefaultPayout> {
	...
	public List<Validator<? super CreditDefaultPayout>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			...
			factory.<cdm.product.asset.CreditDefaultPayout>create(cdm.product.asset.validation.datarule.CreditDefaultPayoutFpMLCd12.class),
			factory.<cdm.product.asset.CreditDefaultPayout>create(cdm.product.asset.validation.datarule.CreditDefaultPayoutQuantity.class)
		);
	}
