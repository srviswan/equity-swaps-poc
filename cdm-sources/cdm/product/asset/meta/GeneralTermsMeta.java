...
public class GeneralTermsMeta implements RosettaMetaData<GeneralTerms> {
	...
	public List<Validator<? super GeneralTerms>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.asset.GeneralTerms>create(cdm.product.asset.validation.datarule.GeneralTermsGeneralTermsChoice.class),
			factory.<cdm.product.asset.GeneralTerms>create(cdm.product.asset.validation.datarule.GeneralTermsFpMLCd41.class),
			factory.<cdm.product.asset.GeneralTerms>create(cdm.product.asset.validation.datarule.GeneralTermsFpMLCd42.class),
			factory.<cdm.product.asset.GeneralTerms>create(cdm.product.asset.validation.datarule.GeneralTermsBasketReferenceInformationNameOrId.class)
		);
	}
