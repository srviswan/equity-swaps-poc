 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FloatingAmountEvents", builder=FloatingAmountEvents.FloatingAmountEventsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FloatingAmountEvents", model="Just another Rosetta model", builder=FloatingAmountEvents.FloatingAmountEventsBuilderImpl.class, version="6.0.0")
