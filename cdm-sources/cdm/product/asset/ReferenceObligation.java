 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ReferenceObligation", builder=ReferenceObligation.ReferenceObligationBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ReferenceObligation", model="Just another Rosetta model", builder=ReferenceObligation.ReferenceObligationBuilderImpl.class, version="6.0.0")
