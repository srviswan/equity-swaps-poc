 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ReturnTermsBase", builder=ReturnTermsBase.ReturnTermsBaseBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ReturnTermsBase", model="Just another Rosetta model", builder=ReturnTermsBase.ReturnTermsBaseBuilderImpl.class, version="6.0.0")
