 ...
 * @version 6.0.0
 */
@RosettaDataType(value="BoundedVariance", builder=BoundedVariance.BoundedVarianceBuilderImpl.class, version="6.0.0")
@RuneDataType(value="BoundedVariance", model="Just another Rosetta model", builder=BoundedVariance.BoundedVarianceBuilderImpl.class, version="6.0.0")
