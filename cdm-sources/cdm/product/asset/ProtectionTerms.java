 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ProtectionTerms", builder=ProtectionTerms.ProtectionTermsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ProtectionTerms", model="Just another Rosetta model", builder=ProtectionTerms.ProtectionTermsBuilderImpl.class, version="6.0.0")
