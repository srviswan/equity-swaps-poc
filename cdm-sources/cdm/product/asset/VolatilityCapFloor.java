 ...
 * @version 6.0.0
 */
@RosettaDataType(value="VolatilityCapFloor", builder=VolatilityCapFloor.VolatilityCapFloorBuilderImpl.class, version="6.0.0")
@RuneDataType(value="VolatilityCapFloor", model="Just another Rosetta model", builder=VolatilityCapFloor.VolatilityCapFloorBuilderImpl.class, version="6.0.0")
