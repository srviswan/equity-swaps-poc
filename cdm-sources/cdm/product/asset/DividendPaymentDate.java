 ...
 * @version 6.0.0
 */
@RosettaDataType(value="DividendPaymentDate", builder=DividendPaymentDate.DividendPaymentDateBuilderImpl.class, version="6.0.0")
@RuneDataType(value="DividendPaymentDate", model="Just another Rosetta model", builder=DividendPaymentDate.DividendPaymentDateBuilderImpl.class, version="6.0.0")
