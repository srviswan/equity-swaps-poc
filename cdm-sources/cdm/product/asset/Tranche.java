 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Tranche", builder=Tranche.TrancheBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Tranche", model="Just another Rosetta model", builder=Tranche.TrancheBuilderImpl.class, version="6.0.0")
