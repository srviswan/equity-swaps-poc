 ...
 * @version 6.0.0
 */
@RosettaDataType(value="VarianceCapFloor", builder=VarianceCapFloor.VarianceCapFloorBuilderImpl.class, version="6.0.0")
@RuneDataType(value="VarianceCapFloor", model="Just another Rosetta model", builder=VarianceCapFloor.VarianceCapFloorBuilderImpl.class, version="6.0.0")
