 ...
 * @version 6.0.0
 */
@RosettaDataType(value="DiscountingMethod", builder=DiscountingMethod.DiscountingMethodBuilderImpl.class, version="6.0.0")
@RuneDataType(value="DiscountingMethod", model="Just another Rosetta model", builder=DiscountingMethod.DiscountingMethodBuilderImpl.class, version="6.0.0")
