 ...
 * @version 6.0.0
 */
@RosettaDataType(value="SettledEntityMatrix", builder=SettledEntityMatrix.SettledEntityMatrixBuilderImpl.class, version="6.0.0")
@RuneDataType(value="SettledEntityMatrix", model="Just another Rosetta model", builder=SettledEntityMatrix.SettledEntityMatrixBuilderImpl.class, version="6.0.0")
