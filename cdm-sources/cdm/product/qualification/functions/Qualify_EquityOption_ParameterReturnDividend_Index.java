	...
	*/
	...
	public static class Qualify_EquityOption_ParameterReturnDividend_IndexDefault extends Qualify_EquityOption_ParameterReturnDividend_Index {
		...
		protected Boolean assignOutput(Boolean is_product, EconomicTerms economicTerms) {
			is_product = exists(MapperS.of(MapperS.of(economicTerms).<Payout>mapC("getPayout", _economicTerms -> _economicTerms.getPayout()).get()).<OptionPayout>map("getOptionPayout", payout -> payout.getOptionPayout())).and(areEqual(MapperS.of(qualify_EquitySwap_ParameterReturnDividend_Index.evaluate(underlierEconomicTerms(economicTerms).get())), MapperS.of(true), CardinalityOperator.All)).get();
