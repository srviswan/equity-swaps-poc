	...
	*/
	...
	public static class Qualify_EquityOption_ParameterReturnDividend_BasketDefault extends Qualify_EquityOption_ParameterReturnDividend_Basket {
		...
		protected Boolean assignOutput(Boolean is_product, EconomicTerms economicTerms) {
			is_product = exists(MapperS.of(MapperS.of(economicTerms).<Payout>mapC("getPayout", _economicTerms -> _economicTerms.getPayout()).get()).<OptionPayout>map("getOptionPayout", payout -> payout.getOptionPayout())).and(areEqual(MapperS.of(qualify_EquitySwap_ParameterReturnDividend_Basket.evaluate(underlierEconomicTerms(economicTerms).get())), MapperS.of(true), CardinalityOperator.All)).get();
