 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PassThroughItem", builder=PassThroughItem.PassThroughItemBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PassThroughItem", model="Just another Rosetta model", builder=PassThroughItem.PassThroughItemBuilderImpl.class, version="6.0.0")
