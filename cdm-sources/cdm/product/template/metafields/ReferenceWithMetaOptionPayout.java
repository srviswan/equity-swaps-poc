...
@RuneDataType(value="ReferenceWithMetaOptionPayout", model="Just another Rosetta model", builder=ReferenceWithMetaOptionPayout.ReferenceWithMetaOptionPayoutBuilderImpl.class, version="0.0.0")
public interface ReferenceWithMetaOptionPayout extends RosettaModelObject, ReferenceWithMeta<OptionPayout> {
	...
	class ReferenceWithMetaOptionPayoutBuilderImpl implements ReferenceWithMetaOptionPayout.ReferenceWithMetaOptionPayoutBuilder {
		...
		@RuneAttribute("@data")
		@RuneMetaType
		public ReferenceWithMetaOptionPayout.ReferenceWithMetaOptionPayoutBuilder setValue(OptionPayout _value) {
		...
		@RosettaAttribute("globalReference")
		@RuneAttribute("@ref")
		public ReferenceWithMetaOptionPayout.ReferenceWithMetaOptionPayoutBuilder setGlobalReference(String _globalReference) {
		...
		@RosettaAttribute("externalReference")
		@RuneAttribute("@ref:external")
		public ReferenceWithMetaOptionPayout.ReferenceWithMetaOptionPayoutBuilder setExternalReference(String _externalReference) {
		...
		@RuneAttribute("@ref:scoped")
		@RuneMetaType
		public ReferenceWithMetaOptionPayout.ReferenceWithMetaOptionPayoutBuilder setReference(Reference _reference) {
