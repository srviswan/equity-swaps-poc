...
@RuneDataType(value="ReferenceWithMetaPayout", model="Just another Rosetta model", builder=ReferenceWithMetaPayout.ReferenceWithMetaPayoutBuilderImpl.class, version="0.0.0")
