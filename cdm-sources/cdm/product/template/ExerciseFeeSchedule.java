 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ExerciseFeeSchedule", builder=ExerciseFeeSchedule.ExerciseFeeScheduleBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ExerciseFeeSchedule", model="Just another Rosetta model", builder=ExerciseFeeSchedule.ExerciseFeeScheduleBuilderImpl.class, version="6.0.0")
