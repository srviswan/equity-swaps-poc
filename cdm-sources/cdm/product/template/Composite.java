 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Composite", builder=Composite.CompositeBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Composite", model="Just another Rosetta model", builder=Composite.CompositeBuilderImpl.class, version="6.0.0")
