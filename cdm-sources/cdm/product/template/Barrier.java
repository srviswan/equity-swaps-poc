 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Barrier", builder=Barrier.BarrierBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Barrier", model="Just another Rosetta model", builder=Barrier.BarrierBuilderImpl.class, version="6.0.0")
