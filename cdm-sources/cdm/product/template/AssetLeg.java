 ...
 * @version 6.0.0
 */
@RosettaDataType(value="AssetLeg", builder=AssetLeg.AssetLegBuilderImpl.class, version="6.0.0")
@RuneDataType(value="AssetLeg", model="Just another Rosetta model", builder=AssetLeg.AssetLegBuilderImpl.class, version="6.0.0")
