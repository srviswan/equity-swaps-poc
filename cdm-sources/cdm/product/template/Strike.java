 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Strike", builder=Strike.StrikeBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Strike", model="Just another Rosetta model", builder=Strike.StrikeBuilderImpl.class, version="6.0.0")
