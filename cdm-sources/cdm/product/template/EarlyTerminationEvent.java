 ...
 * @version 6.0.0
 */
@RosettaDataType(value="EarlyTerminationEvent", builder=EarlyTerminationEvent.EarlyTerminationEventBuilderImpl.class, version="6.0.0")
@RuneDataType(value="EarlyTerminationEvent", model="Just another Rosetta model", builder=EarlyTerminationEvent.EarlyTerminationEventBuilderImpl.class, version="6.0.0")
