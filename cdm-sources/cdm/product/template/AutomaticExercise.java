 ...
 * @version 6.0.0
 */
@RosettaDataType(value="AutomaticExercise", builder=AutomaticExercise.AutomaticExerciseBuilderImpl.class, version="6.0.0")
@RuneDataType(value="AutomaticExercise", model="Just another Rosetta model", builder=AutomaticExercise.AutomaticExerciseBuilderImpl.class, version="6.0.0")
