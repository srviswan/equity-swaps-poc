 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ExerciseProcedure", builder=ExerciseProcedure.ExerciseProcedureBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ExerciseProcedure", model="Just another Rosetta model", builder=ExerciseProcedure.ExerciseProcedureBuilderImpl.class, version="6.0.0")
