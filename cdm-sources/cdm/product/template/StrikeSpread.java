 ...
 * @version 6.0.0
 */
@RosettaDataType(value="StrikeSpread", builder=StrikeSpread.StrikeSpreadBuilderImpl.class, version="6.0.0")
@RuneDataType(value="StrikeSpread", model="Just another Rosetta model", builder=StrikeSpread.StrikeSpreadBuilderImpl.class, version="6.0.0")
