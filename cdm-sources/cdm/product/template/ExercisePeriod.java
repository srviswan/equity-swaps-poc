 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ExercisePeriod", builder=ExercisePeriod.ExercisePeriodBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ExercisePeriod", model="Just another Rosetta model", builder=ExercisePeriod.ExercisePeriodBuilderImpl.class, version="6.0.0")
