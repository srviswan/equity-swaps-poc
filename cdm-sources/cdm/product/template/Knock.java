 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Knock", builder=Knock.KnockBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Knock", model="Just another Rosetta model", builder=Knock.KnockBuilderImpl.class, version="6.0.0")
