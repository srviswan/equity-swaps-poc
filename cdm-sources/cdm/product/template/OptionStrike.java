 ...
 * @version 6.0.0
 */
@RosettaDataType(value="OptionStrike", builder=OptionStrike.OptionStrikeBuilderImpl.class, version="6.0.0")
@RuneDataType(value="OptionStrike", model="Just another Rosetta model", builder=OptionStrike.OptionStrikeBuilderImpl.class, version="6.0.0")
