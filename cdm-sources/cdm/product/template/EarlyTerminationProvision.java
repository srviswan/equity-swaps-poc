 ...
 * @version 6.0.0
 */
@RosettaDataType(value="EarlyTerminationProvision", builder=EarlyTerminationProvision.EarlyTerminationProvisionBuilderImpl.class, version="6.0.0")
@RuneDataType(value="EarlyTerminationProvision", model="Just another Rosetta model", builder=EarlyTerminationProvision.EarlyTerminationProvisionBuilderImpl.class, version="6.0.0")
