 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ManualExercise", builder=ManualExercise.ManualExerciseBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ManualExercise", model="Just another Rosetta model", builder=ManualExercise.ManualExerciseBuilderImpl.class, version="6.0.0")
