 ...
 * @version 6.0.0
 */
@RosettaDataType(value="StrategyFeature", builder=StrategyFeature.StrategyFeatureBuilderImpl.class, version="6.0.0")
@RuneDataType(value="StrategyFeature", model="Just another Rosetta model", builder=StrategyFeature.StrategyFeatureBuilderImpl.class, version="6.0.0")
