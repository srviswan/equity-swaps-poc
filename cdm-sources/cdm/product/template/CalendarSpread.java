 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CalendarSpread", builder=CalendarSpread.CalendarSpreadBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CalendarSpread", model="Just another Rosetta model", builder=CalendarSpread.CalendarSpreadBuilderImpl.class, version="6.0.0")
