 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FxFeature", builder=FxFeature.FxFeatureBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FxFeature", model="Just another Rosetta model", builder=FxFeature.FxFeatureBuilderImpl.class, version="6.0.0")
