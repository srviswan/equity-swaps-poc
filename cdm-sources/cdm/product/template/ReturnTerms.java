 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ReturnTerms", builder=ReturnTerms.ReturnTermsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ReturnTerms", model="Just another Rosetta model", builder=ReturnTerms.ReturnTermsBuilderImpl.class, version="6.0.0")
