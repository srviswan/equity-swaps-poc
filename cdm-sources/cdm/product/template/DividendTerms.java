 ...
 * @version 6.0.0
 */
@RosettaDataType(value="DividendTerms", builder=DividendTerms.DividendTermsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="DividendTerms", model="Just another Rosetta model", builder=DividendTerms.DividendTermsBuilderImpl.class, version="6.0.0")
