...
public class EarlyTerminationEventMeta implements RosettaMetaData<EarlyTerminationEvent> {
	...
	public List<Validator<? super EarlyTerminationEvent>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.template.EarlyTerminationEvent>create(cdm.product.template.validation.datarule.EarlyTerminationEventFpMLIrd39.class),
			factory.<cdm.product.template.EarlyTerminationEvent>create(cdm.product.template.validation.datarule.EarlyTerminationEventFpMLIrd40.class),
			factory.<cdm.product.template.EarlyTerminationEvent>create(cdm.product.template.validation.datarule.EarlyTerminationEventFpMLIrd41.class)
		);
	}
