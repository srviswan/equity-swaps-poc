...
public class CancelableProvisionMeta implements RosettaMetaData<CancelableProvision> {
	...
	public List<Validator<? super CancelableProvision>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.product.template.CancelableProvision>create(cdm.product.template.validation.datarule.CancelableProvisionEffectiveDate.class),
			factory.<cdm.product.template.CancelableProvision>create(cdm.product.template.validation.datarule.CancelableProvisionCancelableProvisionExerciseNoticeReceiverParty.class)
		);
	}
