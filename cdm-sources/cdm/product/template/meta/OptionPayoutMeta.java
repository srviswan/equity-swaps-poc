...
public class OptionPayoutMeta implements RosettaMetaData<OptionPayout> {
	...
	public List<Validator<? super OptionPayout>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			...
			factory.<cdm.product.template.OptionPayout>create(cdm.product.template.validation.datarule.OptionPayoutClearedPhysicalSettlementExists.class),
			factory.<cdm.product.template.OptionPayout>create(cdm.product.template.validation.datarule.OptionPayoutDeliveryCapacity.class),
			factory.<cdm.product.template.OptionPayout>create(cdm.product.template.validation.datarule.OptionPayoutPriceTimeIntervalQuantity.class),
			factory.<cdm.product.template.OptionPayout>create(cdm.product.template.validation.datarule.OptionPayoutOptionStylePresent.class),
			factory.<cdm.product.template.OptionPayout>create(cdm.product.template.validation.datarule.OptionPayoutOptionTypePresent.class)
		);
	}
