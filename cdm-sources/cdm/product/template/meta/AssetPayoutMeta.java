...
public class AssetPayoutMeta implements RosettaMetaData<AssetPayout> {
	...
	public List<Validator<? super AssetPayout>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			...
			factory.<cdm.product.template.AssetPayout>create(cdm.product.template.validation.datarule.AssetPayoutQuantity.class),
			factory.<cdm.product.template.AssetPayout>create(cdm.product.template.validation.datarule.AssetPayoutUnderlierNotCash.class)
		);
	}
