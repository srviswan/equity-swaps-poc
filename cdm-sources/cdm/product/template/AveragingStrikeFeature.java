 ...
 * @version 6.0.0
 */
@RosettaDataType(value="AveragingStrikeFeature", builder=AveragingStrikeFeature.AveragingStrikeFeatureBuilderImpl.class, version="6.0.0")
@RuneDataType(value="AveragingStrikeFeature", model="Just another Rosetta model", builder=AveragingStrikeFeature.AveragingStrikeFeatureBuilderImpl.class, version="6.0.0")
