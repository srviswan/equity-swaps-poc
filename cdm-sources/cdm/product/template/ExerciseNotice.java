 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ExerciseNotice", builder=ExerciseNotice.ExerciseNoticeBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ExerciseNotice", model="Just another Rosetta model", builder=ExerciseNotice.ExerciseNoticeBuilderImpl.class, version="6.0.0")
