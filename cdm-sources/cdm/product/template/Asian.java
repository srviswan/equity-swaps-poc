 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Asian", builder=Asian.AsianBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Asian", model="Just another Rosetta model", builder=Asian.AsianBuilderImpl.class, version="6.0.0")
