 ...
 * @version 6.0.0
 */
@RosettaDataType(value="EvergreenProvision", builder=EvergreenProvision.EvergreenProvisionBuilderImpl.class, version="6.0.0")
@RuneDataType(value="EvergreenProvision", model="Just another Rosetta model", builder=EvergreenProvision.EvergreenProvisionBuilderImpl.class, version="6.0.0")
