 ...
 * @version 6.0.0
 */
@RosettaDataType(value="TerminationProvision", builder=TerminationProvision.TerminationProvisionBuilderImpl.class, version="6.0.0")
@RuneDataType(value="TerminationProvision", model="Just another Rosetta model", builder=TerminationProvision.TerminationProvisionBuilderImpl.class, version="6.0.0")
