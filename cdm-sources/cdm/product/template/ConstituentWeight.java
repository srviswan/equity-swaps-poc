 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ConstituentWeight", builder=ConstituentWeight.ConstituentWeightBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ConstituentWeight", model="Just another Rosetta model", builder=ConstituentWeight.ConstituentWeightBuilderImpl.class, version="6.0.0")
