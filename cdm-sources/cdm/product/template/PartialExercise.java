 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PartialExercise", builder=PartialExercise.PartialExerciseBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PartialExercise", model="Just another Rosetta model", builder=PartialExercise.PartialExerciseBuilderImpl.class, version="6.0.0")
