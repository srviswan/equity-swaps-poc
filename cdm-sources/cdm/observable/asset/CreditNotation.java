 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CreditNotation", builder=CreditNotation.CreditNotationBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CreditNotation", model="Just another Rosetta model", builder=CreditNotation.CreditNotationBuilderImpl.class, version="6.0.0")
