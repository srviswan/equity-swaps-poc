 ...
 * @version 6.0.0
 */
@RosettaDataType(value="RateObservation", builder=RateObservation.RateObservationBuilderImpl.class, version="6.0.0")
@RuneDataType(value="RateObservation", model="Just another Rosetta model", builder=RateObservation.RateObservationBuilderImpl.class, version="6.0.0")
