 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ValuationPostponement", builder=ValuationPostponement.ValuationPostponementBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ValuationPostponement", model="Just another Rosetta model", builder=ValuationPostponement.ValuationPostponementBuilderImpl.class, version="6.0.0")
