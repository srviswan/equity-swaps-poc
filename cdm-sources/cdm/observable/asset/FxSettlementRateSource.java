 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FxSettlementRateSource", builder=FxSettlementRateSource.FxSettlementRateSourceBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FxSettlementRateSource", model="Just another Rosetta model", builder=FxSettlementRateSource.FxSettlementRateSourceBuilderImpl.class, version="6.0.0")
