 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CashPrice", builder=CashPrice.CashPriceBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CashPrice", model="Just another Rosetta model", builder=CashPrice.CashPriceBuilderImpl.class, version="6.0.0")
