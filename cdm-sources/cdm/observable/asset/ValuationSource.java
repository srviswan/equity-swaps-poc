 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ValuationSource", builder=ValuationSource.ValuationSourceBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ValuationSource", model="Just another Rosetta model", builder=ValuationSource.ValuationSourceBuilderImpl.class, version="6.0.0")
