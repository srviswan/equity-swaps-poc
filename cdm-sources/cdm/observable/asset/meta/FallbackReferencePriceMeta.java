...
public class FallbackReferencePriceMeta implements RosettaMetaData<FallbackReferencePrice> {
	...
	public List<Validator<? super FallbackReferencePrice>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.observable.asset.FallbackReferencePrice>create(cdm.observable.asset.validation.datarule.FallbackReferencePriceMaximumDaysOfPostponement.class),
			factory.<cdm.observable.asset.FallbackReferencePrice>create(cdm.observable.asset.validation.datarule.FallbackReferencePriceFallbackCalculationAgent.class)
		);
	}
