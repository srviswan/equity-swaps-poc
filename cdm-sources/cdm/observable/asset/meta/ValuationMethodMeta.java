...
public class ValuationMethodMeta implements RosettaMetaData<ValuationMethod> {
	...
	public List<Validator<? super ValuationMethod>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.observable.asset.ValuationMethod>create(cdm.observable.asset.validation.datarule.ValuationMethodFpMLCd37.class),
			factory.<cdm.observable.asset.ValuationMethod>create(cdm.observable.asset.validation.datarule.ValuationMethodDealer.class)
		);
	}
