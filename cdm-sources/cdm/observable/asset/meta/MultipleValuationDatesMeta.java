...
public class MultipleValuationDatesMeta implements RosettaMetaData<MultipleValuationDates> {
	...
	public List<Validator<? super MultipleValuationDates>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.observable.asset.SingleValuationDate>create(cdm.observable.asset.validation.datarule.SingleValuationDateNonNegativeBusinessDays.class),
			factory.<cdm.observable.asset.MultipleValuationDates>create(cdm.observable.asset.validation.datarule.MultipleValuationDatesBusinessDaysThereafter.class),
			factory.<cdm.observable.asset.MultipleValuationDates>create(cdm.observable.asset.validation.datarule.MultipleValuationDatesNumberValuationDates.class)
		);
	}
