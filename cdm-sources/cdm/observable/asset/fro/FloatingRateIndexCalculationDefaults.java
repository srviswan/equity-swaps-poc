 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FloatingRateIndexCalculationDefaults", builder=FloatingRateIndexCalculationDefaults.FloatingRateIndexCalculationDefaultsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FloatingRateIndexCalculationDefaults", model="Just another Rosetta model", builder=FloatingRateIndexCalculationDefaults.FloatingRateIndexCalculationDefaultsBuilderImpl.class, version="6.0.0")
