 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FloatingRateIndexDefinition", builder=FloatingRateIndexDefinition.FloatingRateIndexDefinitionBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FloatingRateIndexDefinition", model="Just another Rosetta model", builder=FloatingRateIndexDefinition.FloatingRateIndexDefinitionBuilderImpl.class, version="6.0.0")
