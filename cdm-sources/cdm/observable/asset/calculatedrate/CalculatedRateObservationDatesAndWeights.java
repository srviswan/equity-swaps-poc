 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CalculatedRateObservationDatesAndWeights", builder=CalculatedRateObservationDatesAndWeights.CalculatedRateObservationDatesAndWeightsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CalculatedRateObservationDatesAndWeights", model="Just another Rosetta model", builder=CalculatedRateObservationDatesAndWeights.CalculatedRateObservationDatesAndWeightsBuilderImpl.class, version="6.0.0")
