 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ObservationParameters", builder=ObservationParameters.ObservationParametersBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ObservationParameters", model="Just another Rosetta model", builder=ObservationParameters.ObservationParametersBuilderImpl.class, version="6.0.0")
