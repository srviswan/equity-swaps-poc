 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FallbackRateParameters", builder=FallbackRateParameters.FallbackRateParametersBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FallbackRateParameters", model="Just another Rosetta model", builder=FallbackRateParameters.FallbackRateParametersBuilderImpl.class, version="6.0.0")
