 ...
 * @version 6.0.0
 */
@RosettaDataType(value="OffsetCalculation", builder=OffsetCalculation.OffsetCalculationBuilderImpl.class, version="6.0.0")
@RuneDataType(value="OffsetCalculation", model="Just another Rosetta model", builder=OffsetCalculation.OffsetCalculationBuilderImpl.class, version="6.0.0")
