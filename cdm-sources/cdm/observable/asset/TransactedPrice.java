 ...
 * @version 6.0.0
 */
@RosettaDataType(value="TransactedPrice", builder=TransactedPrice.TransactedPriceBuilderImpl.class, version="6.0.0")
@RuneDataType(value="TransactedPrice", model="Just another Rosetta model", builder=TransactedPrice.TransactedPriceBuilderImpl.class, version="6.0.0")
