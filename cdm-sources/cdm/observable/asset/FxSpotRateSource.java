 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FxSpotRateSource", builder=FxSpotRateSource.FxSpotRateSourceBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FxSpotRateSource", model="Just another Rosetta model", builder=FxSpotRateSource.FxSpotRateSourceBuilderImpl.class, version="6.0.0")
