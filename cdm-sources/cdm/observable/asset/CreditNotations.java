 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CreditNotations", builder=CreditNotations.CreditNotationsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CreditNotations", model="Just another Rosetta model", builder=CreditNotations.CreditNotationsBuilderImpl.class, version="6.0.0")
