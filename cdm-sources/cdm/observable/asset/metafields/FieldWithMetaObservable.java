...
@RuneDataType(value="FieldWithMetaObservable", model="Just another Rosetta model", builder=FieldWithMetaObservable.FieldWithMetaObservableBuilderImpl.class, version="0.0.0")
