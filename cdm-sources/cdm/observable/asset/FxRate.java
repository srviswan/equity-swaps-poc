 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FxRate", builder=FxRate.FxRateBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FxRate", model="Just another Rosetta model", builder=FxRate.FxRateBuilderImpl.class, version="6.0.0")
