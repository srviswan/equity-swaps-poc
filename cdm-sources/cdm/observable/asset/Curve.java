 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Curve", builder=Curve.CurveBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Curve", model="Just another Rosetta model", builder=Curve.CurveBuilderImpl.class, version="6.0.0")
