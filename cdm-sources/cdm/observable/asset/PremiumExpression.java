 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PremiumExpression", builder=PremiumExpression.PremiumExpressionBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PremiumExpression", model="Just another Rosetta model", builder=PremiumExpression.PremiumExpressionBuilderImpl.class, version="6.0.0")
