 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ValuationMethod", builder=ValuationMethod.ValuationMethodBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ValuationMethod", model="Just another Rosetta model", builder=ValuationMethod.ValuationMethodBuilderImpl.class, version="6.0.0")
