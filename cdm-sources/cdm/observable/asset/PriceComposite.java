 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PriceComposite", builder=PriceComposite.PriceCompositeBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PriceComposite", model="Just another Rosetta model", builder=PriceComposite.PriceCompositeBuilderImpl.class, version="6.0.0")
