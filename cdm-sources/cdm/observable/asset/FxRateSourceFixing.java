 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FxRateSourceFixing", builder=FxRateSourceFixing.FxRateSourceFixingBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FxRateSourceFixing", model="Just another Rosetta model", builder=FxRateSourceFixing.FxRateSourceFixingBuilderImpl.class, version="6.0.0")
