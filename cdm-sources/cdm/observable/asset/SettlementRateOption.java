 ...
 * @version 6.0.0
 */
@RosettaDataType(value="SettlementRateOption", builder=SettlementRateOption.SettlementRateOptionBuilderImpl.class, version="6.0.0")
@RuneDataType(value="SettlementRateOption", model="Just another Rosetta model", builder=SettlementRateOption.SettlementRateOptionBuilderImpl.class, version="6.0.0")
