 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CreditRatingDebt", builder=CreditRatingDebt.CreditRatingDebtBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CreditRatingDebt", model="Just another Rosetta model", builder=CreditRatingDebt.CreditRatingDebtBuilderImpl.class, version="6.0.0")
