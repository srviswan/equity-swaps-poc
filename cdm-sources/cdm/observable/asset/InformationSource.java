 ...
 * @version 6.0.0
 */
@RosettaDataType(value="InformationSource", builder=InformationSource.InformationSourceBuilderImpl.class, version="6.0.0")
@RuneDataType(value="InformationSource", model="Just another Rosetta model", builder=InformationSource.InformationSourceBuilderImpl.class, version="6.0.0")
