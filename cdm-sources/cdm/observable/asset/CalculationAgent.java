 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CalculationAgent", builder=CalculationAgent.CalculationAgentBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CalculationAgent", model="Just another Rosetta model", builder=CalculationAgent.CalculationAgentBuilderImpl.class, version="6.0.0")
