 ...
 * @version 6.0.0
 */
@RosettaDataType(value="InterestRateCurve", builder=InterestRateCurve.InterestRateCurveBuilderImpl.class, version="6.0.0")
@RuneDataType(value="InterestRateCurve", model="Just another Rosetta model", builder=InterestRateCurve.InterestRateCurveBuilderImpl.class, version="6.0.0")
