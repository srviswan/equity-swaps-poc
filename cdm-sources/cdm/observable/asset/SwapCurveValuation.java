 ...
 * @version 6.0.0
 */
@RosettaDataType(value="SwapCurveValuation", builder=SwapCurveValuation.SwapCurveValuationBuilderImpl.class, version="6.0.0")
@RuneDataType(value="SwapCurveValuation", model="Just another Rosetta model", builder=SwapCurveValuation.SwapCurveValuationBuilderImpl.class, version="6.0.0")
