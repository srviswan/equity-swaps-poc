 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PriceSourceDisruption", builder=PriceSourceDisruption.PriceSourceDisruptionBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PriceSourceDisruption", model="Just another Rosetta model", builder=PriceSourceDisruption.PriceSourceDisruptionBuilderImpl.class, version="6.0.0")
