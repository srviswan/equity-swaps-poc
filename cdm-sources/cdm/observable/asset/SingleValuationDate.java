 ...
 * @version 6.0.0
 */
@RosettaDataType(value="SingleValuationDate", builder=SingleValuationDate.SingleValuationDateBuilderImpl.class, version="6.0.0")
@RuneDataType(value="SingleValuationDate", model="Just another Rosetta model", builder=SingleValuationDate.SingleValuationDateBuilderImpl.class, version="6.0.0")
