 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FeaturePayment", builder=FeaturePayment.FeaturePaymentBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FeaturePayment", model="Just another Rosetta model", builder=FeaturePayment.FeaturePaymentBuilderImpl.class, version="6.0.0")
