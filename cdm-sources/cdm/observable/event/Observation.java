 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Observation", builder=Observation.ObservationBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Observation", model="Just another Rosetta model", builder=Observation.ObservationBuilderImpl.class, version="6.0.0")
