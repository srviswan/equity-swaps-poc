 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FailureToPay", builder=FailureToPay.FailureToPayBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FailureToPay", model="Just another Rosetta model", builder=FailureToPay.FailureToPayBuilderImpl.class, version="6.0.0")
