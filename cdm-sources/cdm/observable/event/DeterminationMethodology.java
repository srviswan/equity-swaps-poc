 ...
 * @version 6.0.0
 */
@RosettaDataType(value="DeterminationMethodology", builder=DeterminationMethodology.DeterminationMethodologyBuilderImpl.class, version="6.0.0")
@RuneDataType(value="DeterminationMethodology", model="Just another Rosetta model", builder=DeterminationMethodology.DeterminationMethodologyBuilderImpl.class, version="6.0.0")
