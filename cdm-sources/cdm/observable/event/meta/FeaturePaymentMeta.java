...
public class FeaturePaymentMeta implements RosettaMetaData<FeaturePayment> {
	...
	public List<Validator<? super FeaturePayment>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.observable.event.FeaturePayment>create(cdm.observable.event.validation.datarule.FeaturePaymentFeaturePaymentChoice.class),
			factory.<cdm.observable.event.FeaturePayment>create(cdm.observable.event.validation.datarule.FeaturePaymentAmount.class)
		);
	}
