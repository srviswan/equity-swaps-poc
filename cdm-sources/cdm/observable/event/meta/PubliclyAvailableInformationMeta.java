...
public class PubliclyAvailableInformationMeta implements RosettaMetaData<PubliclyAvailableInformation> {
	...
	public List<Validator<? super PubliclyAvailableInformation>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.observable.event.PubliclyAvailableInformation>create(cdm.observable.event.validation.datarule.PubliclyAvailableInformationSourceChoice.class),
			factory.<cdm.observable.event.PubliclyAvailableInformation>create(cdm.observable.event.validation.datarule.PubliclyAvailableInformationPositiveSpecifiedNumber.class)
		);
	}
