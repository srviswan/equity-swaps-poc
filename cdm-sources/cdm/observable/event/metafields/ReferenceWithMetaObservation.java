...
@RuneDataType(value="ReferenceWithMetaObservation", model="Just another Rosetta model", builder=ReferenceWithMetaObservation.ReferenceWithMetaObservationBuilderImpl.class, version="0.0.0")
