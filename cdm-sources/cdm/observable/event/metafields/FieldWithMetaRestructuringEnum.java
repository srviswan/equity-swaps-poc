...
@RuneDataType(value="FieldWithMetaRestructuringEnum", model="Just another Rosetta model", builder=FieldWithMetaRestructuringEnum.FieldWithMetaRestructuringEnumBuilderImpl.class, version="0.0.0")
