...
@RuneDataType(value="FieldWithMetaMarketDisruptionEnum", model="Just another Rosetta model", builder=FieldWithMetaMarketDisruptionEnum.FieldWithMetaMarketDisruptionEnumBuilderImpl.class, version="0.0.0")
