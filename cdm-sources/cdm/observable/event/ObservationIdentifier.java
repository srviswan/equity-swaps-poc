 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ObservationIdentifier", builder=ObservationIdentifier.ObservationIdentifierBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ObservationIdentifier", model="Just another Rosetta model", builder=ObservationIdentifier.ObservationIdentifierBuilderImpl.class, version="6.0.0")
