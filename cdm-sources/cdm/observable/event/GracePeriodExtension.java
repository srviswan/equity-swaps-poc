 ...
 * @version 6.0.0
 */
@RosettaDataType(value="GracePeriodExtension", builder=GracePeriodExtension.GracePeriodExtensionBuilderImpl.class, version="6.0.0")
@RuneDataType(value="GracePeriodExtension", model="Just another Rosetta model", builder=GracePeriodExtension.GracePeriodExtensionBuilderImpl.class, version="6.0.0")
