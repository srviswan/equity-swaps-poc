 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CreditEvents", builder=CreditEvents.CreditEventsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CreditEvents", model="Just another Rosetta model", builder=CreditEvents.CreditEventsBuilderImpl.class, version="6.0.0")
