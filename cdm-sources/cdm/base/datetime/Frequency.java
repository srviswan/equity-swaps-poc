 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Frequency", builder=Frequency.FrequencyBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Frequency", model="Just another Rosetta model", builder=Frequency.FrequencyBuilderImpl.class, version="6.0.0")
