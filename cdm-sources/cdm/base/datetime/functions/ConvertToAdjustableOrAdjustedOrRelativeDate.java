	...
	*/
	...
	public static class ConvertToAdjustableOrAdjustedOrRelativeDateDefault extends ConvertToAdjustableOrAdjustedOrRelativeDate {
		...
		protected AdjustableOrAdjustedOrRelativeDate.AdjustableOrAdjustedOrRelativeDateBuilder assignOutput(AdjustableOrAdjustedOrRelativeDate.AdjustableOrAdjustedOrRelativeDateBuilder adjustableOrAdjustedOrRelativeDate, AdjustableOrRelativeDate adjustableOrRelativeDate) {
			final FieldWithMetaDate fieldWithMetaDate = MapperS.of(adjustableOrRelativeDate).<AdjustableDate>map("getAdjustableDate", _adjustableOrRelativeDate -> _adjustableOrRelativeDate.getAdjustableDate()).<FieldWithMetaDate>map("getAdjustedDate", adjustableDate -> adjustableDate.getAdjustedDate()).get();
			...
			if (exists(relativeDate(adjustableOrRelativeDate)).getOrDefault(false)) {
				final ReferenceWithMetaDate referenceWithMetaDate = relativeDate(adjustableOrRelativeDate).<ReferenceWithMetaDate>map("getDateRelativeTo", adjustedRelativeDateOffset -> adjustedRelativeDateOffset.getDateRelativeTo()).get();
