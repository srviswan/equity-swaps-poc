 ...
 * @version 6.0.0
 */
@RosettaDataType(value="BusinessCenterTime", builder=BusinessCenterTime.BusinessCenterTimeBuilderImpl.class, version="6.0.0")
@RuneDataType(value="BusinessCenterTime", model="Just another Rosetta model", builder=BusinessCenterTime.BusinessCenterTimeBuilderImpl.class, version="6.0.0")
