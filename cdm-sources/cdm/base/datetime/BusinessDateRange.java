 ...
 * @version 6.0.0
 */
@RosettaDataType(value="BusinessDateRange", builder=BusinessDateRange.BusinessDateRangeBuilderImpl.class, version="6.0.0")
@RuneDataType(value="BusinessDateRange", model="Just another Rosetta model", builder=BusinessDateRange.BusinessDateRangeBuilderImpl.class, version="6.0.0")
