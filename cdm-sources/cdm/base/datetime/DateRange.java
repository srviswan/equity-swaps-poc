 ...
 * @version 6.0.0
 */
@RosettaDataType(value="DateRange", builder=DateRange.DateRangeBuilderImpl.class, version="6.0.0")
@RuneDataType(value="DateRange", model="Just another Rosetta model", builder=DateRange.DateRangeBuilderImpl.class, version="6.0.0")
