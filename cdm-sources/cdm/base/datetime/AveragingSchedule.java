 ...
 * @version 6.0.0
 */
@RosettaDataType(value="AveragingSchedule", builder=AveragingSchedule.AveragingScheduleBuilderImpl.class, version="6.0.0")
@RuneDataType(value="AveragingSchedule", model="Just another Rosetta model", builder=AveragingSchedule.AveragingScheduleBuilderImpl.class, version="6.0.0")
