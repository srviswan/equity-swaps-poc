 ...
 * @version 6.0.0
 */
@RosettaDataType(value="TimeZone", builder=TimeZone.TimeZoneBuilderImpl.class, version="6.0.0")
@RuneDataType(value="TimeZone", model="Just another Rosetta model", builder=TimeZone.TimeZoneBuilderImpl.class, version="6.0.0")
