 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CustomisableOffset", builder=CustomisableOffset.CustomisableOffsetBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CustomisableOffset", model="Just another Rosetta model", builder=CustomisableOffset.CustomisableOffsetBuilderImpl.class, version="6.0.0")
