...
public class CalculationFrequencyMeta implements RosettaMetaData<CalculationFrequency> {
	...
	public List<Validator<? super CalculationFrequency>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.base.datetime.CalculationFrequency>create(cdm.base.datetime.validation.datarule.CalculationFrequencyMoy.class),
			factory.<cdm.base.datetime.CalculationFrequency>create(cdm.base.datetime.validation.datarule.CalculationFrequencyDom.class),
			factory.<cdm.base.datetime.CalculationFrequency>create(cdm.base.datetime.validation.datarule.CalculationFrequencyWom.class),
			factory.<cdm.base.datetime.CalculationFrequency>create(cdm.base.datetime.validation.datarule.CalculationFrequencyMoyTerm.class),
			factory.<cdm.base.datetime.CalculationFrequency>create(cdm.base.datetime.validation.datarule.CalculationFrequencyDomTerm.class),
			factory.<cdm.base.datetime.CalculationFrequency>create(cdm.base.datetime.validation.datarule.CalculationFrequencyDowTerm.class),
			factory.<cdm.base.datetime.CalculationFrequency>create(cdm.base.datetime.validation.datarule.CalculationFrequencyWomTerm.class)
		);
	}
