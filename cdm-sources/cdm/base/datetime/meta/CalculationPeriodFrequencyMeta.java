...
public class CalculationPeriodFrequencyMeta implements RosettaMetaData<CalculationPeriodFrequency> {
	...
	public List<Validator<? super CalculationPeriodFrequency>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			...
			factory.<cdm.base.datetime.CalculationPeriodFrequency>create(cdm.base.datetime.validation.datarule.CalculationPeriodFrequencyFpMLIrd57.class),
			factory.<cdm.base.datetime.CalculationPeriodFrequency>create(cdm.base.datetime.validation.datarule.CalculationPeriodFrequencyFpMLIrd58.class),
			factory.<cdm.base.datetime.CalculationPeriodFrequency>create(cdm.base.datetime.validation.datarule.CalculationPeriodFrequencyFpMLIrd60.class)
		);
	}
