 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Period", builder=Period.PeriodBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Period", model="Just another Rosetta model", builder=Period.PeriodBuilderImpl.class, version="6.0.0")
