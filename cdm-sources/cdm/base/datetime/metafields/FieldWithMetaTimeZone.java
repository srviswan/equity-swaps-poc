...
@RuneDataType(value="FieldWithMetaTimeZone", model="Just another Rosetta model", builder=FieldWithMetaTimeZone.FieldWithMetaTimeZoneBuilderImpl.class, version="0.0.0")
