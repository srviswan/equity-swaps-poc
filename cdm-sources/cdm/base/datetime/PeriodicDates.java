 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PeriodicDates", builder=PeriodicDates.PeriodicDatesBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PeriodicDates", model="Just another Rosetta model", builder=PeriodicDates.PeriodicDatesBuilderImpl.class, version="6.0.0")
