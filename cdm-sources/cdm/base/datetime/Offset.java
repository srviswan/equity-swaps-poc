 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Offset", builder=Offset.OffsetBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Offset", model="Just another Rosetta model", builder=Offset.OffsetBuilderImpl.class, version="6.0.0")
