 ...
 * @version 6.0.0
 */
@RosettaDataType(value="RelativeDates", builder=RelativeDates.RelativeDatesBuilderImpl.class, version="6.0.0")
@RuneDataType(value="RelativeDates", model="Just another Rosetta model", builder=RelativeDates.RelativeDatesBuilderImpl.class, version="6.0.0")
