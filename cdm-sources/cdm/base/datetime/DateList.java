 ...
 * @version 6.0.0
 */
@RosettaDataType(value="DateList", builder=DateList.DateListBuilderImpl.class, version="6.0.0")
@RuneDataType(value="DateList", model="Just another Rosetta model", builder=DateList.DateListBuilderImpl.class, version="6.0.0")
public interface DateList extends RosettaModelObject {
	...
	class DateListBuilderImpl implements DateList.DateListBuilder {
		...
		@Override
		public DateList.DateListBuilder addDate(Date _date, int _idx) {
			getIndex(this.date, _idx, () -> _date);
			return this;
		}
