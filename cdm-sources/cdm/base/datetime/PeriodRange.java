 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PeriodRange", builder=PeriodRange.PeriodRangeBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PeriodRange", model="Just another Rosetta model", builder=PeriodRange.PeriodRangeBuilderImpl.class, version="6.0.0")
