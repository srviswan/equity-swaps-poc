 ...
 * @version 6.0.0
 */
@RosettaDataType(value="AveragingCalculationMethod", builder=AveragingCalculationMethod.AveragingCalculationMethodBuilderImpl.class, version="6.0.0")
@RuneDataType(value="AveragingCalculationMethod", model="Just another Rosetta model", builder=AveragingCalculationMethod.AveragingCalculationMethodBuilderImpl.class, version="6.0.0")
