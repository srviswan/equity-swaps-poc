 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Measure", builder=Measure.MeasureBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Measure", model="Just another Rosetta model", builder=Measure.MeasureBuilderImpl.class, version="6.0.0")
