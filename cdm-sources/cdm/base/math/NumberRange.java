 ...
 * @version 6.0.0
 */
@RosettaDataType(value="NumberRange", builder=NumberRange.NumberRangeBuilderImpl.class, version="6.0.0")
@RuneDataType(value="NumberRange", model="Just another Rosetta model", builder=NumberRange.NumberRangeBuilderImpl.class, version="6.0.0")
