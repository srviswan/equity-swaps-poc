 ...
 * @version 6.0.0
 */
@RosettaDataType(value="NumberBound", builder=NumberBound.NumberBoundBuilderImpl.class, version="6.0.0")
@RuneDataType(value="NumberBound", model="Just another Rosetta model", builder=NumberBound.NumberBoundBuilderImpl.class, version="6.0.0")
