 ...
 * @version 6.0.0
 */
@RosettaDataType(value="MoneyBound", builder=MoneyBound.MoneyBoundBuilderImpl.class, version="6.0.0")
@RuneDataType(value="MoneyBound", model="Just another Rosetta model", builder=MoneyBound.MoneyBoundBuilderImpl.class, version="6.0.0")
