 ...
 * @version 6.0.0
 */
@RosettaDataType(value="DatedValue", builder=DatedValue.DatedValueBuilderImpl.class, version="6.0.0")
@RuneDataType(value="DatedValue", model="Just another Rosetta model", builder=DatedValue.DatedValueBuilderImpl.class, version="6.0.0")
