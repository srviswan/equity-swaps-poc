 ...
 * @version 6.0.0
 */
@RosettaDataType(value="MeasureBase", builder=MeasureBase.MeasureBaseBuilderImpl.class, version="6.0.0")
@RuneDataType(value="MeasureBase", model="Just another Rosetta model", builder=MeasureBase.MeasureBaseBuilderImpl.class, version="6.0.0")
