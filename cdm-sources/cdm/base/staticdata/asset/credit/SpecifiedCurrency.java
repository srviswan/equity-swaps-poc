 ...
 * @version 6.0.0
 */
@RosettaDataType(value="SpecifiedCurrency", builder=SpecifiedCurrency.SpecifiedCurrencyBuilderImpl.class, version="6.0.0")
@RuneDataType(value="SpecifiedCurrency", model="Just another Rosetta model", builder=SpecifiedCurrency.SpecifiedCurrencyBuilderImpl.class, version="6.0.0")
