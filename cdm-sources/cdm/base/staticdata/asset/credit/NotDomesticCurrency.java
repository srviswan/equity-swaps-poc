 ...
 * @version 6.0.0
 */
@RosettaDataType(value="NotDomesticCurrency", builder=NotDomesticCurrency.NotDomesticCurrencyBuilderImpl.class, version="6.0.0")
@RuneDataType(value="NotDomesticCurrency", model="Just another Rosetta model", builder=NotDomesticCurrency.NotDomesticCurrencyBuilderImpl.class, version="6.0.0")
