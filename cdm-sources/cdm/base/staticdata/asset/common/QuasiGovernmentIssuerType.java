 ...
 * @version 6.0.0
 */
@RosettaDataType(value="QuasiGovernmentIssuerType", builder=QuasiGovernmentIssuerType.QuasiGovernmentIssuerTypeBuilderImpl.class, version="6.0.0")
@RuneDataType(value="QuasiGovernmentIssuerType", model="Just another Rosetta model", builder=QuasiGovernmentIssuerType.QuasiGovernmentIssuerTypeBuilderImpl.class, version="6.0.0")
