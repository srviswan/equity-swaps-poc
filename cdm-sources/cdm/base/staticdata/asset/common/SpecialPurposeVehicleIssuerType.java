 ...
 * @version 6.0.0
 */
@RosettaDataType(value="SpecialPurposeVehicleIssuerType", builder=SpecialPurposeVehicleIssuerType.SpecialPurposeVehicleIssuerTypeBuilderImpl.class, version="6.0.0")
@RuneDataType(value="SpecialPurposeVehicleIssuerType", model="Just another Rosetta model", builder=SpecialPurposeVehicleIssuerType.SpecialPurposeVehicleIssuerTypeBuilderImpl.class, version="6.0.0")
