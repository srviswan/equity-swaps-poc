 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CommodityReferenceFramework", builder=CommodityReferenceFramework.CommodityReferenceFrameworkBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CommodityReferenceFramework", model="Just another Rosetta model", builder=CommodityReferenceFramework.CommodityReferenceFrameworkBuilderImpl.class, version="6.0.0")
