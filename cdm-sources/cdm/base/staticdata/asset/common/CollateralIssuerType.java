 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CollateralIssuerType", builder=CollateralIssuerType.CollateralIssuerTypeBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CollateralIssuerType", model="Just another Rosetta model", builder=CollateralIssuerType.CollateralIssuerTypeBuilderImpl.class, version="6.0.0")
