 ...
 * @version 6.0.0
 */
@RosettaDataType(value="RegionalGovernmentIssuerType", builder=RegionalGovernmentIssuerType.RegionalGovernmentIssuerTypeBuilderImpl.class, version="6.0.0")
@RuneDataType(value="RegionalGovernmentIssuerType", model="Just another Rosetta model", builder=RegionalGovernmentIssuerType.RegionalGovernmentIssuerTypeBuilderImpl.class, version="6.0.0")
