 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ProductIdentifier", builder=ProductIdentifier.ProductIdentifierBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ProductIdentifier", model="Just another Rosetta model", builder=ProductIdentifier.ProductIdentifierBuilderImpl.class, version="6.0.0")
