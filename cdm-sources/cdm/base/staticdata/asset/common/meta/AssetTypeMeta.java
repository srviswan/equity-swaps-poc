...
public class AssetTypeMeta implements RosettaMetaData<AssetType> {
	...
	public List<Validator<? super AssetType>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.base.staticdata.asset.common.AssetType>create(cdm.base.staticdata.asset.common.validation.datarule.AssetTypeSecuritySubType.class),
			factory.<cdm.base.staticdata.asset.common.AssetType>create(cdm.base.staticdata.asset.common.validation.datarule.AssetTypeBondSubType.class),
			factory.<cdm.base.staticdata.asset.common.AssetType>create(cdm.base.staticdata.asset.common.validation.datarule.AssetTypeEquitySubType.class),
			factory.<cdm.base.staticdata.asset.common.AssetType>create(cdm.base.staticdata.asset.common.validation.datarule.AssetTypeFundSubType.class),
			factory.<cdm.base.staticdata.asset.common.AssetType>create(cdm.base.staticdata.asset.common.validation.datarule.AssetTypeOtherAssetSubType.class)
		);
	}
