...
public class SecurityMeta implements RosettaMetaData<Security> {
	...
	public List<Validator<? super Security>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			...
			factory.<cdm.base.staticdata.asset.common.Security>create(cdm.base.staticdata.asset.common.validation.datarule.SecurityDebtSubType.class),
			factory.<cdm.base.staticdata.asset.common.Security>create(cdm.base.staticdata.asset.common.validation.datarule.SecurityEquitySubType.class),
			factory.<cdm.base.staticdata.asset.common.Security>create(cdm.base.staticdata.asset.common.validation.datarule.SecurityFundSubType.class)
		);
	}
