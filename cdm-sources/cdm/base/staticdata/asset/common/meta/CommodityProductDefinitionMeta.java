...
public class CommodityProductDefinitionMeta implements RosettaMetaData<CommodityProductDefinition> {
	...
	public List<Validator<? super CommodityProductDefinition>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.base.staticdata.asset.common.CommodityProductDefinition>create(cdm.base.staticdata.asset.common.validation.datarule.CommodityProductDefinitionCommodityProductDefinitionChoice.class)
		);
	}
