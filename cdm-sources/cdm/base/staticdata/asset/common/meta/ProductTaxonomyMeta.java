...
public class ProductTaxonomyMeta implements RosettaMetaData<ProductTaxonomy> {
	...
	public List<Validator<? super ProductTaxonomy>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.base.staticdata.asset.common.Taxonomy>create(cdm.base.staticdata.asset.common.validation.datarule.TaxonomyDifferentOrdinals.class),
			factory.<cdm.base.staticdata.asset.common.ProductTaxonomy>create(cdm.base.staticdata.asset.common.validation.datarule.ProductTaxonomyTaxonomyType.class),
			factory.<cdm.base.staticdata.asset.common.ProductTaxonomy>create(cdm.base.staticdata.asset.common.validation.datarule.ProductTaxonomyTaxonomySource.class),
			factory.<cdm.base.staticdata.asset.common.ProductTaxonomy>create(cdm.base.staticdata.asset.common.validation.datarule.ProductTaxonomyTaxonomyValue.class)
		);
	}
