...
public class CollateralTaxonomyMeta implements RosettaMetaData<CollateralTaxonomy> {
	...
	public List<Validator<? super CollateralTaxonomy>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.base.staticdata.asset.common.CollateralTaxonomy>create(cdm.base.staticdata.asset.common.validation.datarule.CollateralTaxonomyEuEligibleCollateralTaxonomy.class),
			factory.<cdm.base.staticdata.asset.common.CollateralTaxonomy>create(cdm.base.staticdata.asset.common.validation.datarule.CollateralTaxonomyUkEligibleCollateralTaxonomy.class),
			factory.<cdm.base.staticdata.asset.common.CollateralTaxonomy>create(cdm.base.staticdata.asset.common.validation.datarule.CollateralTaxonomyUsEligibleCollateralTaxonomy.class),
			factory.<cdm.base.staticdata.asset.common.CollateralTaxonomy>create(cdm.base.staticdata.asset.common.validation.datarule.CollateralTaxonomyTaxonomyValue.class)
		);
	}
