...
public class QuasiGovernmentIssuerTypeMeta implements RosettaMetaData<QuasiGovernmentIssuerType> {
	...
	public List<Validator<? super QuasiGovernmentIssuerType>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.base.staticdata.asset.common.QuasiGovernmentIssuerType>create(cdm.base.staticdata.asset.common.validation.datarule.QuasiGovernmentIssuerTypeNonSovereignEntityRecourse.class)
		);
	}
