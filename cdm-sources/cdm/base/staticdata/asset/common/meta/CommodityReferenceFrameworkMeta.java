...
public class CommodityReferenceFrameworkMeta implements RosettaMetaData<CommodityReferenceFramework> {
	...
	public List<Validator<? super CommodityReferenceFramework>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.base.staticdata.asset.common.CommodityReferenceFramework>create(cdm.base.staticdata.asset.common.validation.datarule.CommodityReferenceFrameworkCommodityReferenceFrameworkChoice.class)
		);
	}
