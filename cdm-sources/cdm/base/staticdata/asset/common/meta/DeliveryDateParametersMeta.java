...
public class DeliveryDateParametersMeta implements RosettaMetaData<DeliveryDateParameters> {
	...
	public List<Validator<? super DeliveryDateParameters>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.base.staticdata.asset.common.DeliveryDateParameters>create(cdm.base.staticdata.asset.common.validation.datarule.DeliveryDateParametersDeliveryDateParametersChoice.class)
		);
	}
