 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PriceSource", builder=PriceSource.PriceSourceBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PriceSource", model="Just another Rosetta model", builder=PriceSource.PriceSourceBuilderImpl.class, version="6.0.0")
