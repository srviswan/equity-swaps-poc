 ...
 * @version 6.0.0
 */
@RosettaDataType(value="DeliveryDateParameters", builder=DeliveryDateParameters.DeliveryDateParametersBuilderImpl.class, version="6.0.0")
@RuneDataType(value="DeliveryDateParameters", model="Just another Rosetta model", builder=DeliveryDateParameters.DeliveryDateParametersBuilderImpl.class, version="6.0.0")
