 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Taxonomy", builder=Taxonomy.TaxonomyBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Taxonomy", model="Just another Rosetta model", builder=Taxonomy.TaxonomyBuilderImpl.class, version="6.0.0")
