 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CollateralTaxonomy", builder=CollateralTaxonomy.CollateralTaxonomyBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CollateralTaxonomy", model="Just another Rosetta model", builder=CollateralTaxonomy.CollateralTaxonomyBuilderImpl.class, version="6.0.0")
