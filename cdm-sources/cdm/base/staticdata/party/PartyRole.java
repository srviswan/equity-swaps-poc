 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PartyRole", builder=PartyRole.PartyRoleBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PartyRole", model="Just another Rosetta model", builder=PartyRole.PartyRoleBuilderImpl.class, version="6.0.0")
