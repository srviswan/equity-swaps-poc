...
@RuneDataType(value="FieldWithMetaAccountTypeEnum", model="Just another Rosetta model", builder=FieldWithMetaAccountTypeEnum.FieldWithMetaAccountTypeEnumBuilderImpl.class, version="0.0.0")
