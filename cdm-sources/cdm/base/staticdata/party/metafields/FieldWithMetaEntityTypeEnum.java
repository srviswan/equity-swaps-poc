...
@RuneDataType(value="FieldWithMetaEntityTypeEnum", model="Just another Rosetta model", builder=FieldWithMetaEntityTypeEnum.FieldWithMetaEntityTypeEnumBuilderImpl.class, version="0.0.0")
