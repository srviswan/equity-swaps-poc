...
@RuneDataType(value="ReferenceWithMetaAccount", model="Just another Rosetta model", builder=ReferenceWithMetaAccount.ReferenceWithMetaAccountBuilderImpl.class, version="0.0.0")
