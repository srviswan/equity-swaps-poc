...
@RuneDataType(value="FieldWithMetaPersonIdentifier", model="Just another Rosetta model", builder=FieldWithMetaPersonIdentifier.FieldWithMetaPersonIdentifierBuilderImpl.class, version="0.0.0")
