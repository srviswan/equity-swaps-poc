...
@RuneDataType(value="ReferenceWithMetaParty", model="Just another Rosetta model", builder=ReferenceWithMetaParty.ReferenceWithMetaPartyBuilderImpl.class, version="0.0.0")
