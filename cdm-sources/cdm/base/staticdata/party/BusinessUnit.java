 ...
 * @version 6.0.0
 */
@RosettaDataType(value="BusinessUnit", builder=BusinessUnit.BusinessUnitBuilderImpl.class, version="6.0.0")
@RuneDataType(value="BusinessUnit", model="Just another Rosetta model", builder=BusinessUnit.BusinessUnitBuilderImpl.class, version="6.0.0")
