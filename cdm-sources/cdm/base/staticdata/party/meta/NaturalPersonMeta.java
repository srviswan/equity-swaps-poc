...
public class NaturalPersonMeta implements RosettaMetaData<NaturalPerson> {
	...
	public List<Validator<? super NaturalPerson>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.base.staticdata.party.NaturalPerson>create(cdm.base.staticdata.party.validation.datarule.NaturalPersonNameOrIdChoice.class),
			factory.<cdm.base.staticdata.party.NaturalPerson>create(cdm.base.staticdata.party.validation.datarule.NaturalPersonNaturalPersonChoice.class)
		);
	}
