 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ReferenceBank", builder=ReferenceBank.ReferenceBankBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ReferenceBank", model="Just another Rosetta model", builder=ReferenceBank.ReferenceBankBuilderImpl.class, version="6.0.0")
