 ...
 * @version 6.0.0
 */
@RosettaDataType(value="RelatedParty", builder=RelatedParty.RelatedPartyBuilderImpl.class, version="6.0.0")
@RuneDataType(value="RelatedParty", model="Just another Rosetta model", builder=RelatedParty.RelatedPartyBuilderImpl.class, version="6.0.0")
