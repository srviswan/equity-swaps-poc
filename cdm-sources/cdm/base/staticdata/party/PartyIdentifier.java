 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PartyIdentifier", builder=PartyIdentifier.PartyIdentifierBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PartyIdentifier", model="Just another Rosetta model", builder=PartyIdentifier.PartyIdentifierBuilderImpl.class, version="6.0.0")
