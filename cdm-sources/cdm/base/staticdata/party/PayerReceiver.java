 ...
 * @version 6.0.0
 */
@RosettaDataType(value="PayerReceiver", builder=PayerReceiver.PayerReceiverBuilderImpl.class, version="6.0.0")
@RuneDataType(value="PayerReceiver", model="Just another Rosetta model", builder=PayerReceiver.PayerReceiverBuilderImpl.class, version="6.0.0")
