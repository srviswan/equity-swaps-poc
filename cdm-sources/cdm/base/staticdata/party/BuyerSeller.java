 ...
 * @version 6.0.0
 */
@RosettaDataType(value="BuyerSeller", builder=BuyerSeller.BuyerSellerBuilderImpl.class, version="6.0.0")
@RuneDataType(value="BuyerSeller", model="Just another Rosetta model", builder=BuyerSeller.BuyerSellerBuilderImpl.class, version="6.0.0")
