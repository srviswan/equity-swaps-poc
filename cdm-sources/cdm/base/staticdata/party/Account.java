 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Account", builder=Account.AccountBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Account", model="Just another Rosetta model", builder=Account.AccountBuilderImpl.class, version="6.0.0")
