 ...
 * @version 6.0.0
 */
@RosettaDataType(value="AssignedIdentifier", builder=AssignedIdentifier.AssignedIdentifierBuilderImpl.class, version="6.0.0")
@RuneDataType(value="AssignedIdentifier", model="Just another Rosetta model", builder=AssignedIdentifier.AssignedIdentifierBuilderImpl.class, version="6.0.0")
