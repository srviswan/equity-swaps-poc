...
public class LocationIdentifierMeta implements RosettaMetaData<LocationIdentifier> {
	...
	public List<Validator<? super LocationIdentifier>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.base.staticdata.identifier.Identifier>create(cdm.base.staticdata.identifier.validation.datarule.IdentifierIssuerChoice.class),
			factory.<cdm.base.staticdata.identifier.LocationIdentifier>create(cdm.base.staticdata.identifier.validation.datarule.LocationIdentifierIdentifierType.class)
		);
	}
