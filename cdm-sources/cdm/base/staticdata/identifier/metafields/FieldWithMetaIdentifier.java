...
@RuneDataType(value="FieldWithMetaIdentifier", model="Just another Rosetta model", builder=FieldWithMetaIdentifier.FieldWithMetaIdentifierBuilderImpl.class, version="0.0.0")
