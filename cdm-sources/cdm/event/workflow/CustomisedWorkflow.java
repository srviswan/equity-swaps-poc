 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CustomisedWorkflow", builder=CustomisedWorkflow.CustomisedWorkflowBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CustomisedWorkflow", model="Just another Rosetta model", builder=CustomisedWorkflow.CustomisedWorkflowBuilderImpl.class, version="6.0.0")
