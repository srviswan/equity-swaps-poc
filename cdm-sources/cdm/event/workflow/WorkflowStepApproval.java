 ...
 * @version 6.0.0
 */
@RosettaDataType(value="WorkflowStepApproval", builder=WorkflowStepApproval.WorkflowStepApprovalBuilderImpl.class, version="6.0.0")
@RuneDataType(value="WorkflowStepApproval", model="Just another Rosetta model", builder=WorkflowStepApproval.WorkflowStepApprovalBuilderImpl.class, version="6.0.0")
