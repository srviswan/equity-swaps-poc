...
@RuneDataType(value="ReferenceWithMetaWorkflowStep", model="Just another Rosetta model", builder=ReferenceWithMetaWorkflowStep.ReferenceWithMetaWorkflowStepBuilderImpl.class, version="0.0.0")
