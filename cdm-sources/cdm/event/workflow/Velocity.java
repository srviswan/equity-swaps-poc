 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Velocity", builder=Velocity.VelocityBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Velocity", model="Just another Rosetta model", builder=Velocity.VelocityBuilderImpl.class, version="6.0.0")
