...
public class WorkflowStepMeta implements RosettaMetaData<WorkflowStep> {
	...
	public List<Validator<? super WorkflowStep>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.event.workflow.WorkflowStep>create(cdm.event.workflow.validation.datarule.WorkflowStepWorkflowStepStatus.class),
			factory.<cdm.event.workflow.WorkflowStep>create(cdm.event.workflow.validation.datarule.WorkflowStepCounterpartyPositionBusinessEventOrBusinessEventChoice.class)
		);
	}
