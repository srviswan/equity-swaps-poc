 ...
 * @version 6.0.0
 */
@RosettaDataType(value="EventTimestamp", builder=EventTimestamp.EventTimestampBuilderImpl.class, version="6.0.0")
@RuneDataType(value="EventTimestamp", model="Just another Rosetta model", builder=EventTimestamp.EventTimestampBuilderImpl.class, version="6.0.0")
