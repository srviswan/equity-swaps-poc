 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CollateralBalance", builder=CollateralBalance.CollateralBalanceBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CollateralBalance", model="Just another Rosetta model", builder=CollateralBalance.CollateralBalanceBuilderImpl.class, version="6.0.0")
