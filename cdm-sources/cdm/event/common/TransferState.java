 ...
 * @version 6.0.0
 */
@RosettaDataType(value="TransferState", builder=TransferState.TransferStateBuilderImpl.class, version="6.0.0")
@RuneDataType(value="TransferState", model="Just another Rosetta model", builder=TransferState.TransferStateBuilderImpl.class, version="6.0.0")
