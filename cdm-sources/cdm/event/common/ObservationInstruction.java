 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ObservationInstruction", builder=ObservationInstruction.ObservationInstructionBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ObservationInstruction", model="Just another Rosetta model", builder=ObservationInstruction.ObservationInstructionBuilderImpl.class, version="6.0.0")
