 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ExerciseEvent", builder=ExerciseEvent.ExerciseEventBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ExerciseEvent", model="Just another Rosetta model", builder=ExerciseEvent.ExerciseEventBuilderImpl.class, version="6.0.0")
