 ...
 * @version 6.0.0
 */
@RosettaDataType(value="TransferExpression", builder=TransferExpression.TransferExpressionBuilderImpl.class, version="6.0.0")
@RuneDataType(value="TransferExpression", model="Just another Rosetta model", builder=TransferExpression.TransferExpressionBuilderImpl.class, version="6.0.0")
