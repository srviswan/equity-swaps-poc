 ...
 * @version 6.0.0
 */
@RosettaDataType(value="StockSplitInstruction", builder=StockSplitInstruction.StockSplitInstructionBuilderImpl.class, version="6.0.0")
@RuneDataType(value="StockSplitInstruction", model="Just another Rosetta model", builder=StockSplitInstruction.StockSplitInstructionBuilderImpl.class, version="6.0.0")
