 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Instruction", builder=Instruction.InstructionBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Instruction", model="Just another Rosetta model", builder=Instruction.InstructionBuilderImpl.class, version="6.0.0")
