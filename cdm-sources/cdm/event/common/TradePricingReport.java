 ...
 * @version 6.0.0
 */
@RosettaDataType(value="TradePricingReport", builder=TradePricingReport.TradePricingReportBuilderImpl.class, version="6.0.0")
@RuneDataType(value="TradePricingReport", model="Just another Rosetta model", builder=TradePricingReport.TradePricingReportBuilderImpl.class, version="6.0.0")
