 ...
 * @version 6.0.0
 */
@RosettaDataType(value="CorporateAction", builder=CorporateAction.CorporateActionBuilderImpl.class, version="6.0.0")
@RuneDataType(value="CorporateAction", model="Just another Rosetta model", builder=CorporateAction.CorporateActionBuilderImpl.class, version="6.0.0")
