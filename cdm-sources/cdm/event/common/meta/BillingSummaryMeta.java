...
public class BillingSummaryMeta implements RosettaMetaData<BillingSummary> {
	...
	public List<Validator<? super BillingSummary>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.event.common.BillingSummary>create(cdm.event.common.validation.datarule.BillingSummaryGrandTotal.class),
			factory.<cdm.event.common.BillingSummary>create(cdm.event.common.validation.datarule.BillingSummaryParentTotal.class),
			factory.<cdm.event.common.BillingSummary>create(cdm.event.common.validation.datarule.BillingSummaryAccountTotal.class)
		);
	}
