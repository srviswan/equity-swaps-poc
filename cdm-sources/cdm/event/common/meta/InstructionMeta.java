...
public class InstructionMeta implements RosettaMetaData<Instruction> {
	...
	public List<Validator<? super Instruction>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.event.common.Instruction>create(cdm.event.common.validation.datarule.InstructionExclusiveSplitPrimitive.class),
			factory.<cdm.event.common.Instruction>create(cdm.event.common.validation.datarule.InstructionNewTrade.class)
		);
	}
