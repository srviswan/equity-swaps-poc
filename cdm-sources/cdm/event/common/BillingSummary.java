 ...
 * @version 6.0.0
 */
@RosettaDataType(value="BillingSummary", builder=BillingSummary.BillingSummaryBuilderImpl.class, version="6.0.0")
@RuneDataType(value="BillingSummary", model="Just another Rosetta model", builder=BillingSummary.BillingSummaryBuilderImpl.class, version="6.0.0")
