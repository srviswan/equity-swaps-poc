 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ExecutionDetails", builder=ExecutionDetails.ExecutionDetailsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ExecutionDetails", model="Just another Rosetta model", builder=ExecutionDetails.ExecutionDetailsBuilderImpl.class, version="6.0.0")
