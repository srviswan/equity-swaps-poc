 ...
 * @version 6.0.0
 */
@RosettaDataType(value="BillingSummaryInstruction", builder=BillingSummaryInstruction.BillingSummaryInstructionBuilderImpl.class, version="6.0.0")
@RuneDataType(value="BillingSummaryInstruction", model="Just another Rosetta model", builder=BillingSummaryInstruction.BillingSummaryInstructionBuilderImpl.class, version="6.0.0")
