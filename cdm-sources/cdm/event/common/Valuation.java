 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Valuation", builder=Valuation.ValuationBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Valuation", model="Just another Rosetta model", builder=Valuation.ValuationBuilderImpl.class, version="6.0.0")
