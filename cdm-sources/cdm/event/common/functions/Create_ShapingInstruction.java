			...
			instruction
				...
				.addBreakdown(thenArg
					.mapListToItem(item -> {
						...
						final FieldWithMetaDate fieldWithMetaDate = MapperS.of(tradeState).<Trade>map("getTrade", _tradeState -> _tradeState.getTrade()).<FieldWithMetaDate>map("getTradeDate", trade -> trade.getTradeDate()).get();
