 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ScheduledTransfer", builder=ScheduledTransfer.ScheduledTransferBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ScheduledTransfer", model="Just another Rosetta model", builder=ScheduledTransfer.ScheduledTransferBuilderImpl.class, version="6.0.0")
