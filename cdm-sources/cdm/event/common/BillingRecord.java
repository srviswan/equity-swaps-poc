 ...
 * @version 6.0.0
 */
@RosettaDataType(value="BillingRecord", builder=BillingRecord.BillingRecordBuilderImpl.class, version="6.0.0")
@RuneDataType(value="BillingRecord", model="Just another Rosetta model", builder=BillingRecord.BillingRecordBuilderImpl.class, version="6.0.0")
