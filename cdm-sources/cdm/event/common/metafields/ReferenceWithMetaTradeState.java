...
@RuneDataType(value="ReferenceWithMetaTradeState", model="Just another Rosetta model", builder=ReferenceWithMetaTradeState.ReferenceWithMetaTradeStateBuilderImpl.class, version="0.0.0")
