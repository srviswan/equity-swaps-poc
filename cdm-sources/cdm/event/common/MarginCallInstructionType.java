 ...
 * @version 6.0.0
 */
@RosettaDataType(value="MarginCallInstructionType", builder=MarginCallInstructionType.MarginCallInstructionTypeBuilderImpl.class, version="6.0.0")
@RuneDataType(value="MarginCallInstructionType", model="Just another Rosetta model", builder=MarginCallInstructionType.MarginCallInstructionTypeBuilderImpl.class, version="6.0.0")
