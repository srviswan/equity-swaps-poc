 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Exposure", builder=Exposure.ExposureBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Exposure", model="Just another Rosetta model", builder=Exposure.ExposureBuilderImpl.class, version="6.0.0")
