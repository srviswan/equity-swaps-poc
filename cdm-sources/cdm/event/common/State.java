 ...
 * @version 6.0.0
 */
@RosettaDataType(value="State", builder=State.StateBuilderImpl.class, version="6.0.0")
@RuneDataType(value="State", model="Just another Rosetta model", builder=State.StateBuilderImpl.class, version="6.0.0")
