 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ObservationEvent", builder=ObservationEvent.ObservationEventBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ObservationEvent", model="Just another Rosetta model", builder=ObservationEvent.ObservationEventBuilderImpl.class, version="6.0.0")
