...
public class AvailableInventoryRecordMeta implements RosettaMetaData<AvailableInventoryRecord> {
	...
	public List<Validator<? super AvailableInventoryRecord>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.event.position.AvailableInventoryRecord>create(cdm.event.position.validation.datarule.AvailableInventoryRecordInterestRate.class),
			factory.<cdm.event.position.AvailableInventoryRecord>create(cdm.event.position.validation.datarule.AvailableInventoryRecordValidPartyRole.class)
		);
	}
