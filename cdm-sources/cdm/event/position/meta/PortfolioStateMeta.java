...
public class PortfolioStateMeta implements RosettaMetaData<PortfolioState> {
	...
	public List<Validator<? super PortfolioState>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.event.position.PortfolioState>create(cdm.event.position.validation.datarule.PortfolioStateInitialisation.class),
			factory.<cdm.event.position.PortfolioState>create(cdm.event.position.validation.datarule.PortfolioStateNonTransferable.class)
		);
	}
