 ...
 * @version 6.0.0
 */
@RosettaDataType(value="InventoryRecord", builder=InventoryRecord.InventoryRecordBuilderImpl.class, version="6.0.0")
@RuneDataType(value="InventoryRecord", model="Just another Rosetta model", builder=InventoryRecord.InventoryRecordBuilderImpl.class, version="6.0.0")
