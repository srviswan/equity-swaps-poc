 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Portfolio", builder=Portfolio.PortfolioBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Portfolio", model="Just another Rosetta model", builder=Portfolio.PortfolioBuilderImpl.class, version="6.0.0")
