 ...
 * @version 6.0.0
 */
@RosettaDataType(value="EquityMasterConfirmation", builder=EquityMasterConfirmation.EquityMasterConfirmationBuilderImpl.class, version="6.0.0")
@RuneDataType(value="EquityMasterConfirmation", model="Just another Rosetta model", builder=EquityMasterConfirmation.EquityMasterConfirmationBuilderImpl.class, version="6.0.0")
