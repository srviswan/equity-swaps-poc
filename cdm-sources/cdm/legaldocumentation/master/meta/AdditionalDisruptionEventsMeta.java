...
public class AdditionalDisruptionEventsMeta implements RosettaMetaData<AdditionalDisruptionEvents> {
	...
	public List<Validator<? super AdditionalDisruptionEvents>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.legaldocumentation.master.AdditionalDisruptionEvents>create(cdm.legaldocumentation.master.validation.datarule.AdditionalDisruptionEventsMaximumStockLoanRate.class),
			factory.<cdm.legaldocumentation.master.AdditionalDisruptionEvents>create(cdm.legaldocumentation.master.validation.datarule.AdditionalDisruptionEventsInitialStockLoanRate.class),
			factory.<cdm.legaldocumentation.master.AdditionalDisruptionEvents>create(cdm.legaldocumentation.master.validation.datarule.AdditionalDisruptionEventsDisruptionEventsDeterminingParty.class)
		);
	}
