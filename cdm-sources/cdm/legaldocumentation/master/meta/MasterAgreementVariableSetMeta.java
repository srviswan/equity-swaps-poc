...
public class MasterAgreementVariableSetMeta implements RosettaMetaData<MasterAgreementVariableSet> {
	...
	public List<Validator<? super MasterAgreementVariableSet>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.legaldocumentation.master.MasterAgreementVariableSet>create(cdm.legaldocumentation.master.validation.datarule.MasterAgreementVariableSetVariableSetExists.class),
			factory.<cdm.legaldocumentation.master.MasterAgreementVariableSet>create(cdm.legaldocumentation.master.validation.datarule.MasterAgreementVariableSetVariableSetNesting.class),
			factory.<cdm.legaldocumentation.master.MasterAgreementVariableSet>create(cdm.legaldocumentation.master.validation.datarule.MasterAgreementVariableSetNameMustExist.class),
			factory.<cdm.legaldocumentation.master.MasterAgreementVariableSet>create(cdm.legaldocumentation.master.validation.datarule.MasterAgreementVariableSetValueMustExist.class)
		);
	}
