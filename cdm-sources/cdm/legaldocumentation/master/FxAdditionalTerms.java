 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FxAdditionalTerms", builder=FxAdditionalTerms.FxAdditionalTermsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FxAdditionalTerms", model="Just another Rosetta model", builder=FxAdditionalTerms.FxAdditionalTermsBuilderImpl.class, version="6.0.0")
