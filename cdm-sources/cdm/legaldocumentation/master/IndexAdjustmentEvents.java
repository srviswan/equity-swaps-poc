 ...
 * @version 6.0.0
 */
@RosettaDataType(value="IndexAdjustmentEvents", builder=IndexAdjustmentEvents.IndexAdjustmentEventsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="IndexAdjustmentEvents", model="Just another Rosetta model", builder=IndexAdjustmentEvents.IndexAdjustmentEventsBuilderImpl.class, version="6.0.0")
