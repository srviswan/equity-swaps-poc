 ...
 * @version 6.0.0
 */
@RosettaDataType(value="OtherAgreement", builder=OtherAgreement.OtherAgreementBuilderImpl.class, version="6.0.0")
@RuneDataType(value="OtherAgreement", model="Just another Rosetta model", builder=OtherAgreement.OtherAgreementBuilderImpl.class, version="6.0.0")
