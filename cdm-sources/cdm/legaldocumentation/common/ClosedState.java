 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ClosedState", builder=ClosedState.ClosedStateBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ClosedState", model="Just another Rosetta model", builder=ClosedState.ClosedStateBuilderImpl.class, version="6.0.0")
