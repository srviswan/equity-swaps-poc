...
public class LegalAgreementMeta implements RosettaMetaData<LegalAgreement> {
	...
	public List<Validator<? super LegalAgreement>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.legaldocumentation.common.LegalAgreement>create(cdm.legaldocumentation.common.validation.datarule.LegalAgreementConsistentlyExecutedAgreements.class),
			factory.<cdm.legaldocumentation.common.LegalAgreement>create(cdm.legaldocumentation.common.validation.datarule.LegalAgreementAgreementVerification.class)
		);
	}
