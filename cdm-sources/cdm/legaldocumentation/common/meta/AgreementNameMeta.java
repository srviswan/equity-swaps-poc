...
public class AgreementNameMeta implements RosettaMetaData<AgreementName> {
	...
	public List<Validator<? super AgreementName>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.legaldocumentation.common.AgreementName>create(cdm.legaldocumentation.common.validation.datarule.AgreementNameAgreementType.class),
			factory.<cdm.legaldocumentation.common.AgreementName>create(cdm.legaldocumentation.common.validation.datarule.AgreementNameCreditSupportAgreement.class),
			factory.<cdm.legaldocumentation.common.AgreementName>create(cdm.legaldocumentation.common.validation.datarule.AgreementNameMasterConfirmation.class),
			factory.<cdm.legaldocumentation.common.AgreementName>create(cdm.legaldocumentation.common.validation.datarule.AgreementNameCSAMarginType.class)
		);
	}
