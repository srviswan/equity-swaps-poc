...
public class OtherAgreementTermsMeta implements RosettaMetaData<OtherAgreementTerms> {
	...
	public List<Validator<? super OtherAgreementTerms>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<cdm.legaldocumentation.common.OtherAgreementTerms>create(cdm.legaldocumentation.common.validation.datarule.OtherAgreementTermsLegalDocumentNotSpecified.class),
			factory.<cdm.legaldocumentation.common.OtherAgreementTerms>create(cdm.legaldocumentation.common.validation.datarule.OtherAgreementTermsLegalDocumentSpecified.class)
		);
	}
