 ...
 * @version 6.0.0
 */
@RosettaDataType(value="ResourceLength", builder=ResourceLength.ResourceLengthBuilderImpl.class, version="6.0.0")
@RuneDataType(value="ResourceLength", model="Just another Rosetta model", builder=ResourceLength.ResourceLengthBuilderImpl.class, version="6.0.0")
