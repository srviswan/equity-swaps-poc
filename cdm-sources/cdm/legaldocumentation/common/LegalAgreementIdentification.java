 ...
 * @version 6.0.0
 */
@RosettaDataType(value="LegalAgreementIdentification", builder=LegalAgreementIdentification.LegalAgreementIdentificationBuilderImpl.class, version="6.0.0")
@RuneDataType(value="LegalAgreementIdentification", model="Just another Rosetta model", builder=LegalAgreementIdentification.LegalAgreementIdentificationBuilderImpl.class, version="6.0.0")
