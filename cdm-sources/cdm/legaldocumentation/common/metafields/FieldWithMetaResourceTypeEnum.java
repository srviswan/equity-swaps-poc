...
@RuneDataType(value="FieldWithMetaResourceTypeEnum", model="Just another Rosetta model", builder=FieldWithMetaResourceTypeEnum.FieldWithMetaResourceTypeEnumBuilderImpl.class, version="0.0.0")
