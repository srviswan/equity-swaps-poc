 ...
 * @version 6.0.0
 */
@RosettaDataType(value="OtherAgreementTerms", builder=OtherAgreementTerms.OtherAgreementTermsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="OtherAgreementTerms", model="Just another Rosetta model", builder=OtherAgreementTerms.OtherAgreementTermsBuilderImpl.class, version="6.0.0")
