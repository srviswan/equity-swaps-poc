 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Tx", builder=Tx.TxBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Tx", model="Just another Rosetta model", builder=Tx.TxBuilderImpl.class, version="6.0.0")
