 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Pric", builder=Pric.PricBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Pric", model="Just another Rosetta model", builder=Pric.PricBuilderImpl.class, version="6.0.0")
