 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Qty", builder=Qty.QtyBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Qty", model="Just another Rosetta model", builder=Qty.QtyBuilderImpl.class, version="6.0.0")
