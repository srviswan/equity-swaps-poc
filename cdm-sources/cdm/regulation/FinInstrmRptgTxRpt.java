 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FinInstrmRptgTxRpt", builder=FinInstrmRptgTxRpt.FinInstrmRptgTxRptBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FinInstrmRptgTxRpt", model="Just another Rosetta model", builder=FinInstrmRptgTxRpt.FinInstrmRptgTxRptBuilderImpl.class, version="6.0.0")
