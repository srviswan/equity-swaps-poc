 ...
 * @version 6.0.0
 */
@RosettaDataType(value="AddtlAttrbts", builder=AddtlAttrbts.AddtlAttrbtsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="AddtlAttrbts", model="Just another Rosetta model", builder=AddtlAttrbts.AddtlAttrbtsBuilderImpl.class, version="6.0.0")
