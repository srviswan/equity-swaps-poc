 ...
 * @version 6.0.0
 */
@RosettaDataType(value="New", builder=New.NewBuilderImpl.class, version="6.0.0")
@RuneDataType(value="New", model="Just another Rosetta model", builder=New.NewBuilderImpl.class, version="6.0.0")
