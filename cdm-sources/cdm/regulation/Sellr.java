 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Sellr", builder=Sellr.SellrBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Sellr", model="Just another Rosetta model", builder=Sellr.SellrBuilderImpl.class, version="6.0.0")
