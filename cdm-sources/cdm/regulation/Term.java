 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Term", builder=Term.TermBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Term", model="Just another Rosetta model", builder=Term.TermBuilderImpl.class, version="6.0.0")
