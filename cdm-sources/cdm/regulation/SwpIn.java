 ...
 * @version 6.0.0
 */
@RosettaDataType(value="SwpIn", builder=SwpIn.SwpInBuilderImpl.class, version="6.0.0")
@RuneDataType(value="SwpIn", model="Just another Rosetta model", builder=SwpIn.SwpInBuilderImpl.class, version="6.0.0")
