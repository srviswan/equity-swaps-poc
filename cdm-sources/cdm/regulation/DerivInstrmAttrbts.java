 ...
 * @version 6.0.0
 */
@RosettaDataType(value="DerivInstrmAttrbts", builder=DerivInstrmAttrbts.DerivInstrmAttrbtsBuilderImpl.class, version="6.0.0")
@RuneDataType(value="DerivInstrmAttrbts", model="Just another Rosetta model", builder=DerivInstrmAttrbts.DerivInstrmAttrbtsBuilderImpl.class, version="6.0.0")
