 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Document", builder=Document.DocumentBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Document", model="Just another Rosetta model", builder=Document.DocumentBuilderImpl.class, version="6.0.0")
