 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Id", builder=Id.IdBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Id", model="Just another Rosetta model", builder=Id.IdBuilderImpl.class, version="6.0.0")
