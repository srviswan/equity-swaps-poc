 ...
 * @version 6.0.0
 */
@RosettaDataType(value="UndrlygInstrm", builder=UndrlygInstrm.UndrlygInstrmBuilderImpl.class, version="6.0.0")
@RuneDataType(value="UndrlygInstrm", model="Just another Rosetta model", builder=UndrlygInstrm.UndrlygInstrmBuilderImpl.class, version="6.0.0")
