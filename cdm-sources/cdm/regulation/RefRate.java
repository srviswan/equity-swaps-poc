 ...
 * @version 6.0.0
 */
@RosettaDataType(value="RefRate", builder=RefRate.RefRateBuilderImpl.class, version="6.0.0")
@RuneDataType(value="RefRate", model="Just another Rosetta model", builder=RefRate.RefRateBuilderImpl.class, version="6.0.0")
