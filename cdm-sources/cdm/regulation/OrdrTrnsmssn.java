 ...
 * @version 6.0.0
 */
@RosettaDataType(value="OrdrTrnsmssn", builder=OrdrTrnsmssn.OrdrTrnsmssnBuilderImpl.class, version="6.0.0")
@RuneDataType(value="OrdrTrnsmssn", model="Just another Rosetta model", builder=OrdrTrnsmssn.OrdrTrnsmssnBuilderImpl.class, version="6.0.0")
