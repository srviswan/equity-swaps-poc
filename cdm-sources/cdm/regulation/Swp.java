 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Swp", builder=Swp.SwpBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Swp", model="Just another Rosetta model", builder=Swp.SwpBuilderImpl.class, version="6.0.0")
