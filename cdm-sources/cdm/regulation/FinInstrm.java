 ...
 * @version 6.0.0
 */
@RosettaDataType(value="FinInstrm", builder=FinInstrm.FinInstrmBuilderImpl.class, version="6.0.0")
@RuneDataType(value="FinInstrm", model="Just another Rosetta model", builder=FinInstrm.FinInstrmBuilderImpl.class, version="6.0.0")
