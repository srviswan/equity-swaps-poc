 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Indx", builder=Indx.IndxBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Indx", model="Just another Rosetta model", builder=Indx.IndxBuilderImpl.class, version="6.0.0")
