 ...
 * @version 6.0.0
 */
@RosettaDataType(value="Nm", builder=Nm.NmBuilderImpl.class, version="6.0.0")
@RuneDataType(value="Nm", model="Just another Rosetta model", builder=Nm.NmBuilderImpl.class, version="6.0.0")
