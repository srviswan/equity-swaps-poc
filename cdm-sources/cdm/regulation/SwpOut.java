 ...
 * @version 6.0.0
 */
@RosettaDataType(value="SwpOut", builder=SwpOut.SwpOutBuilderImpl.class, version="6.0.0")
@RuneDataType(value="SwpOut", model="Just another Rosetta model", builder=SwpOut.SwpOutBuilderImpl.class, version="6.0.0")
