...
def InterestRateObservableCondition(pq: PriceQuantity) -> bool:
    ...
    def _then_fn0():
        return all_elements(map(lambda item: (all_elements(rosetta_resolve_attr(self, "priceType"), "=", rosetta_resolve_attr(PriceTypeEnum, "INTEREST_RATE")) and rosetta_attr_exists(rosetta_resolve_attr(self, "arithmeticOperator"))), rosetta_resolve_attr(rosetta_resolve_attr(self, "pq"), "price")), "=", True)
