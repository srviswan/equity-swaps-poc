...
__all__ = ['Qualify_InterestRate_InflationSwap_Basis_ZeroCoupon']


@replaceable
def Qualify_InterestRate_InflationSwap_Basis_ZeroCoupon(economicTerms: EconomicTerms) -> bool:
    """
