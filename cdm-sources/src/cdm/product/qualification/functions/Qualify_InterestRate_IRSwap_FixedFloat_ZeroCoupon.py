...
__all__ = ['Qualify_InterestRate_IRSwap_FixedFloat_ZeroCoupon']


@replaceable
def Qualify_InterestRate_IRSwap_FixedFloat_ZeroCoupon(economicTerms: EconomicTerms) -> bool:
    """
