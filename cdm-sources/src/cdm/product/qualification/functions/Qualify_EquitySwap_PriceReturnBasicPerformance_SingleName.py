...
__all__ = ['Qualify_EquitySwap_PriceReturnBasicPerformance_SingleName']


@replaceable
def Qualify_EquitySwap_PriceReturnBasicPerformance_SingleName(economicTerms: EconomicTerms) -> bool:
    """
