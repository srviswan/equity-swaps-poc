...
__all__ = ['Qualify_EquitySwap_PriceReturnBasicPerformance_Index']


@replaceable
def Qualify_EquitySwap_PriceReturnBasicPerformance_Index(economicTerms: EconomicTerms) -> bool:
    """
