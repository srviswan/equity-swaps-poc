...
__all__ = ['Qualify_CreditDefaultSwap_Basket']


@replaceable
def Qualify_CreditDefaultSwap_Basket(economicTerms: EconomicTerms) -> bool:
    """
    ...
    is_product =  (all_elements(Qualify_AssetClass_Credit(rosetta_resolve_attr(self, "economicTerms")), "=", True) and rosetta_attr_exists(rosetta_resolve_attr(rosetta_resolve_attr(rosetta_resolve_attr(rosetta_resolve_attr(rosetta_resolve_attr(self, "economicTerms"), "payout"), "CreditDefaultPayout"), "generalTerms"), "basketReferenceInformation")))
