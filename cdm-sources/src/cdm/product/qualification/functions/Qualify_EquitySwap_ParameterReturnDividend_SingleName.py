...
__all__ = ['Qualify_EquitySwap_ParameterReturnDividend_SingleName']


@replaceable
def Qualify_EquitySwap_ParameterReturnDividend_SingleName(economicTerms: EconomicTerms) -> bool:
    """
