...
class CalculationPeriodDates(BaseDataClass):
    ...
    """
    stubPeriodType: Optional[cdm.product.common.schedule.StubPeriodTypeEnum.StubPeriodTypeEnum] = Field(None, description="Method to allocate any irregular period remaining after regular periods have been allocated between the effective and termination date.")
    """
    ...
    """
    calculationPeriodFrequency: Optional[cdm.base.datetime.CalculationPeriodFrequency.CalculationPeriodFrequency] = Field(None, description="The frequency at which calculation period end dates occur with the regular part of the calculation period schedule and their roll date convention.")
    """
    ...
    def condition_0_FpML_ird_16(self):
        ...
        item = self
        def _then_fn0():
            return all_elements(rosetta_resolve_attr(rosetta_resolve_attr(rosetta_resolve_attr(self, "terminationDate"), "adjustableDate"), "unadjustedDate"), ">", rosetta_resolve_attr(self, "firstRegularPeriodStartDate"))
        
        def _else_fn0():
            return True
        
        return if_cond_fn(rosetta_attr_exists(rosetta_resolve_attr(self, "firstRegularPeriodStartDate")), _then_fn0, _else_fn0)
    ...
    def condition_1_FpML_ird_17(self):
        ...
        item = self
        def _then_fn0():
            return all_elements(rosetta_resolve_attr(rosetta_resolve_attr(rosetta_resolve_attr(self, "terminationDate"), "adjustableDate"), "unadjustedDate"), ">", rosetta_resolve_attr(self, "lastRegularPeriodEndDate"))
        
        def _else_fn0():
            return True
        
        return if_cond_fn(rosetta_attr_exists(rosetta_resolve_attr(self, "lastRegularPeriodEndDate")), _then_fn0, _else_fn0)
    ...
    def condition_2_FpML_ird_18(self):
        ...
        item = self
        def _then_fn0():
            return all_elements(rosetta_resolve_attr(self, "lastRegularPeriodEndDate"), ">", rosetta_resolve_attr(self, "firstRegularPeriodStartDate"))
        
        def _else_fn0():
            return True
        
        return if_cond_fn((rosetta_attr_exists(rosetta_resolve_attr(self, "firstRegularPeriodStartDate")) and rosetta_attr_exists(rosetta_resolve_attr(self, "lastRegularPeriodEndDate"))), _then_fn0, _else_fn0)
    ...
    def condition_3_FpML_ird_20(self):
        ...
        item = self
        def _then_fn0():
            return all_elements(rosetta_resolve_attr(self, "lastRegularPeriodEndDate"), ">", rosetta_resolve_attr(rosetta_resolve_attr(rosetta_resolve_attr(self, "effectiveDate"), "adjustableDate"), "unadjustedDate"))
    ...
    def condition_4_FpML_ird_21(self):
        ...
        item = self
        def _then_fn0():
            return all_elements(rosetta_resolve_attr(rosetta_resolve_attr(rosetta_resolve_attr(self, "firstPeriodStartDate"), "adjustableDate"), "unadjustedDate"), "<", rosetta_resolve_attr(rosetta_resolve_attr(rosetta_resolve_attr(self, "effectiveDate"), "adjustableDate"), "unadjustedDate"))
        
        def _else_fn0():
            return True
        
        return if_cond_fn((rosetta_attr_exists(rosetta_resolve_attr(self, "firstPeriodStartDate")) and rosetta_attr_exists(rosetta_resolve_attr(self, "effectiveDate"))), _then_fn0, _else_fn0)
    ...
    def condition_5_FpML_ird_22(self):
        ...
        item = self
        def _then_fn0():
            return all_elements(rosetta_resolve_attr(rosetta_resolve_attr(rosetta_resolve_attr(self, "firstPeriodStartDate"), "adjustableDate"), "unadjustedDate"), "<", rosetta_resolve_attr(self, "firstRegularPeriodStartDate"))
        
        def _else_fn0():
            return True
        
        return if_cond_fn((rosetta_attr_exists(rosetta_resolve_attr(self, "firstPeriodStartDate")) and rosetta_attr_exists(rosetta_resolve_attr(self, "firstRegularPeriodStartDate"))), _then_fn0, _else_fn0)
