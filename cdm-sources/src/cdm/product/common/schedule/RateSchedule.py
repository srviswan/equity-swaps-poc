...
class RateSchedule(BaseDataClass):
    ...
    """
    price: AttributeWithAddress[cdm.observable.asset.PriceSchedule.PriceSchedule] | cdm.observable.asset.PriceSchedule.PriceSchedule = Field(..., description="The initial rate. An initial rate of 5% would be represented as 0.05.")
    """
