...
class PositionIdentifier(Identifier):
    ...
    """
    identifierType: Optional[cdm.base.staticdata.identifier.TradeIdentifierTypeEnum.TradeIdentifierTypeEnum] = Field(None, description="The enumerated classification of the identifier. Optional as a position identifier may be party-specific, in which case it may not correspond to any established classification.")
    """
