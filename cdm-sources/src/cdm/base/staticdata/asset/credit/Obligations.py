...
class Obligations(BaseDataClass):
    ...
    """
    category: cdm.base.staticdata.asset.credit.ObligationCategoryEnum.ObligationCategoryEnum = Field(..., description="Used in both obligations and deliverable obligations to represent a class or type of securities which apply. ISDA 2003 Term: Obligation Category/Deliverable Obligation Category.")
    """
