...
class PartyIdentifier(BaseDataClass):
    ...
    """
    identifierType: Optional[cdm.base.staticdata.party.PartyIdentifierTypeEnum.PartyIdentifierTypeEnum] = Field(None, description="Defines the source of the identifier.")
    """
