...
class Resource(BaseDataClass):
    ...
    """
    resourceType: Optional[AttributeWithMeta[cdm.legaldocumentation.common.ResourceTypeEnum.ResourceTypeEnum] | cdm.legaldocumentation.common.ResourceTypeEnum.ResourceTypeEnum] = Field(None, description="A description of the type of the resource, e.g. a confirmation.")
    """
    ...
    """
    length: Optional[cdm.legaldocumentation.common.ResourceLength.ResourceLength] = Field(None, description="Indicates the length of the resource. For example, if the resource were a PDF file, the length would be in pages.")
    """
