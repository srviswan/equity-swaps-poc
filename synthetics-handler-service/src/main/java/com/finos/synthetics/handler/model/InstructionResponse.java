package com.finos.synthetics.handler.model;
...
/**
 * Instruction Response Model for Handler Service
 * 
 * Represents the response from processing a CDM primitive instruction in the handler service.
 * 
 * @version 1.0.0
 */
