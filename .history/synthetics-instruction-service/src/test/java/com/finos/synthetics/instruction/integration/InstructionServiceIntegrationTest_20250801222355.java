...
class InstructionServiceIntegrationTest {
    ...
    @MockBean
    private com.finos.synthetics.instruction.service.InstructionProcessorService instructionProcessorService;

    @MockBean
    private com.finos.synthetics.instruction.service.InstructionValidationService instructionValidationService;

    @MockBean
    private com.finos.synthetics.instruction.client.HandlerServiceClient handlerServiceClient;
