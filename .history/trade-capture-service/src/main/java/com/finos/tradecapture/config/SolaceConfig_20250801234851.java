...
public class SolaceConfig {
     ...
     * Note: This is disabled for development. In production, you would use the actual Solace JMS API.
     */
    /*
    @Bean
    public ConnectionFactory solaceConnectionFactory() {
        try {
            ...
            return new org.springframework.jms.connection.CachingConnectionFactory();
    ...
    public DefaultMessageListenerContainer jmsMessageListenerContainer() {
        ...
        container.setAutoStartup(false); // Disable auto-startup for development
