...
class ArchivalOrchestrator:
    ...
    def run_monthly_archival(self):
        ...
        # Note: Monthly archival tables are handled automatically by the comprehensive workflow
        logger.info("=" * 80)
        logger.info("Archival workflow completed - all data moved directly to archive_db")
