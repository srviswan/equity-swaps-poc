# Data Archival System V2 - Complete Implementation

A production-ready, metadata-driven archival framework for 100+ tables across multiple databases, designed for SQL Server 2019 with Python orchestration, filegroup-based architecture, and database portability.
...
- **Archival flag management**: Clean, efficient archival using archival_flag column
