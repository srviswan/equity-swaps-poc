...
class HandlerServiceIntegrationTest {
    ...
    void shouldReturnHealthStatus() throws Exception {
        mockMvc.perform(get("/handler-service/health"))
    ...
    void shouldReturnServiceInfo() throws Exception {
        mockMvc.perform(get("/handler-service/info"))
                .andExpect(status().isOk())
    ...
    void shouldHandleInvalidJsonRequest() throws Exception {
        mockMvc.perform(post("/handler-service/process")
    ...
    void shouldHandleCorsPreflightRequest() throws Exception {
        mockMvc.perform(options("/handler-service/process")
    ...
    void shouldTestAllHandlerEndpoints() throws Exception {
        ...
        mockMvc.perform(post("/handler-service/execution")
                .contentType(MediaType.APPLICATION_JSON)
        ...
        mockMvc.perform(post("/handler-service/contract-formation")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(createValidRequest())))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        ...
        mockMvc.perform(post("/handler-service/exercise")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(createValidRequest())))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        ...
        // Test reset endpoint
        mockMvc.perform(post("/handler-service/reset")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(createValidRequest())))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        ...
        mockMvc.perform(post("/handler-service/party-change")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(createValidRequest())))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
