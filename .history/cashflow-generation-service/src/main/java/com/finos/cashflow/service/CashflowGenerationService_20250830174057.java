    ...
    public Mono<BatchCashflowGenerationResponse> generateBatchCashflows(BatchCashflowGenerationRequest batchRequest) {
        ...
        return Mono.fromCallable(() -> {
            ...
            BatchCashflowGenerationResponse response = new BatchCashflowGenerationResponse(
                jobId, 
                totalRequests, 
                totalRequests, // acceptedRequests - all accepted for this mock
                0 // rejectedRequests
            );
            
            logger.info("Completed batch cashflow generation: jobId={}, totalRequests={}", 
                       response.getJobId(), response.getTotalRequests());
