...
public interface CashflowRepository extends ReactiveCrudRepository<Cashflow, UUID> {
    ...
    Flux<Cashflow> findByContractIdAndType(UUID contractId, CashflowType type);
    
    // Find cashflows by contract ID and cashflow type (alias for compatibility)
    ...
    Flux<Cashflow> findByType(CashflowType type);
    ...
    Flux<Cashflow> findByContractIdInAndType(List<UUID> contractIds, CashflowType type);
