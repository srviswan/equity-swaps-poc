...
public class CashflowRealizationRequest {
    ...
    private PerformanceCashflowGenerationRequest.MarketData marketData;
    private PerformanceCashflowGenerationRequest.CalculationMethod calculationMethod;
    ...
    public PerformanceCashflowGenerationRequest.MarketData getMarketData() {
        return marketData;
    }
    
    public void setMarketData(PerformanceCashflowGenerationRequest.MarketData marketData) {
        this.marketData = marketData;
    }
    
    public PerformanceCashflowGenerationRequest.CalculationMethod getCalculationMethod() {
        return calculationMethod;
    }
    
    public void setCalculationMethod(PerformanceCashflowGenerationRequest.CalculationMethod calculationMethod) {
