...
public class CashflowGenerationService {
    ...
    public Mono<CashflowGenerationResponse> generateDividendCashflows(CashflowGenerationRequest request) {
        ...
        List<CashflowType> cashflowTypes = request.getCashflowTypes();
        if (cashflowTypes == null || cashflowTypes.isEmpty()) {
            cashflowTypes = List.of(CashflowType.DIVIDEND);
        }
