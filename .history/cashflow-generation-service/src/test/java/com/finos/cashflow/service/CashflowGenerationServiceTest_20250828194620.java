...
class CashflowGenerationServiceTest {
    ...
    void generateCashflows_ShouldReturnAcceptedResponse() {
        ...
        CompletableFuture<Cashflow> mockFuture = CompletableFuture.completedFuture(mockCashflow);
    ...
    void generateCashflows_WithMultipleContracts_ShouldProcessAll() {
        ...
        CompletableFuture<Cashflow> mockFuture1 = CompletableFuture.completedFuture(mockCashflow1);
        CompletableFuture<Cashflow> mockFuture2 = CompletableFuture.completedFuture(mockCashflow2);
