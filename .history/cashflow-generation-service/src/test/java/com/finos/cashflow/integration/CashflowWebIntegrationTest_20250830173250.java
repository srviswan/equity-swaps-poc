...
public class CashflowWebIntegrationTest {
    ...
    void testCashflowGenerationEndpoints() {
        ...
        dividendRequest.setDividendType(DividendCashflowGenerationRequest.DividendType.ORDINARY);
    ...
    private CashflowGenerationRequest createBasicGenerationRequest() {
        ...
        // Primary calculation type is auto-calculated from cashflow types
        return request;
    }
}
