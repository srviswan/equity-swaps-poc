...
class ActorBasedCashflowServiceTest {
    ...
    @BeforeEach
    void setUp() {
        actorBasedCashflowService = new ActorBasedCashflowService();
    }
    ...
    void generateCashflows_ShouldReturnAcceptedResponse() {
        ...
        // When
        Mono<CashflowGenerationResponse> result = actorBasedCashflowService.generateCashflows(request);
        ...
        StepVerifier.create(result)
            .assertNext(response -> {
                ...
                assertThat(response.getMessage()).contains("Actor pattern");
            })
            .verifyComplete();
    }
