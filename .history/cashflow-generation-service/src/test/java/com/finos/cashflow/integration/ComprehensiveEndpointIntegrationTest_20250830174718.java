...
/**
 * Comprehensive integration test that validates all endpoints in a production-like configuration.
 * This test runs the actual Spring Boot application with a real web server.
 */
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("test")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class ComprehensiveEndpointIntegrationTest {
    ...
    void testInterestCashflowGeneration() {
        ...
        request.setPrincipalCurrency("USD");
    ...
    void testDividendCashflowGeneration() {
        ...
        request.setContractIds(Arrays.asList(UUID.randomUUID()));
        request.setCalculationDate(LocalDate.now());
        request.setDividendAmount(50.0);
        request.setExDividendDate(LocalDate.now().minusDays(1));
        request.setPaymentDate(LocalDate.now().plusDays(7));
    ...
    void testPerformanceCashflowGeneration() {
        ...
        request.setContractIds(Arrays.asList(UUID.randomUUID()));
        request.setCalculationDate(LocalDate.now());
        request.setMarketValue(1050000.0);
        request.setPreviousMarketValue(1000000.0);
        request.setNotionalAmount(1000000.0);
    ...
    void testBatchCashflowGeneration() {
        ...
        batchRequest.setRequests(Arrays.asList(createTestRequest()));
    ...
    void testCashflowStatusUpdate() {
        ...
        request.setNewStatus(CashflowStatus.CONFIRMED);
    ...
    void testCashflowDeferral() {
        ...
        request.setCashflowIds(Arrays.asList(UUID.randomUUID()));
        request.setDeferralReason(DeferralReason.MARKET_CONDITIONS);
        request.setNewDueDate(LocalDate.now().plusDays(30));
        request.setUpdatedBy("integration-test");
    ...
    void testCashflowRealization() {
        ...
        request.setCashflowIds(Arrays.asList(UUID.randomUUID()));
        request.setRealizedAmount(100000.0);
    ...
    void testCashflowSettlement() {
        ...
        request.setSettlementAmount(100000.0);
        request.setUpdatedBy("integration-test");
    ...
    void testBatchInterestGeneration() {
        ...
        request.setRequests(Arrays.asList(createInterestRequest()));
    ...
    void testBatchEquityGeneration() {
        ...
        request.setRequests(Arrays.asList(createPerformanceRequest()));
    ...
    void testConcurrentOperations() {
        ...
        List<Mono<String>> requests = Arrays.asList(
    ...
    private Mono<String> performRequest(String path) {
